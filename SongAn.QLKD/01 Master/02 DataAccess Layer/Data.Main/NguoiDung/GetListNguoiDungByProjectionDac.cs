...
namespace SongAn.QLKD.Data.QLKD.NguoiDung
{
    public class GetListNguoiDungByProjectionDac : BaseRepositoryAsync
    {
        ...
        private void Init()
        {
            FieldsField = FieldsField.Equals("") ? nameof(Entity.QLKD_MAIN.Entity.NguoiDung.NguoiDungId) : FieldsField;

            OrderClause = OrderClause.Equals("") ? nameof(Entity.QLKD_MAIN.Entity.NguoiDung.NguoiDungId) : OrderClause;
