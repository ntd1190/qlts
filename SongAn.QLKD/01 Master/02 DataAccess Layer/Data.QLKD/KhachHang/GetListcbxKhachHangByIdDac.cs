...
namespace SongAn.QLKD.Data.QLNS.KhachHang
{
    public class GetListcbxKhachHangByIdDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxKhachHangByIdDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_KhachHang_cbxKhachHangById",
                    param: p,
