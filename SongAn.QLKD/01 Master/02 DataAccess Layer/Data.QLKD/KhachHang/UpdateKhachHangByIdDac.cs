...
{
    public class UpdateKhachHangByIdDac: BaseRepositoryAsync
    {
        ...
        public UpdateKhachHangByIdDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_KhachHang_UpdateKhachHangById",
                    param: p,
