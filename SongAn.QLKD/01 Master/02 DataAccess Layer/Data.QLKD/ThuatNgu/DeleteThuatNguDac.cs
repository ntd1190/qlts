...
{
    public class DeleteThuatNguDac : BaseRepositoryAsync
    {
        #region public properties

        public virtual string THUATNGUIDS { get; set; }
        ...
        public DeleteThuatNguDac(ContextDto context) : base(context.dbQLKDConnection)
        {
