...
{
    public class GetListDieuPhoiByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListDieuPhoiByCriteriaDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("NhanVienDieuPhoiId", NhanVienDieuPhoiId, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_DieuPhoi_GetListDieuPhoiByCriteria",
                    param: p,
