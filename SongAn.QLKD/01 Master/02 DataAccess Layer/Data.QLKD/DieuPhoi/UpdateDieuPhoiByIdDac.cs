...
{
    public class UpdateDieuPhoiByIdDac : BaseRepositoryAsync
    {
        #region public properties

        public int DieuPhoiId { get; set; }
        ...
        public UpdateDieuPhoiByIdDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("DieuPhoiId", DieuPhoiId, DbType.Int32);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                        sql: "sp_KD_DieuPhoi_UpdateDieuPhoiById",
                        param: p,
