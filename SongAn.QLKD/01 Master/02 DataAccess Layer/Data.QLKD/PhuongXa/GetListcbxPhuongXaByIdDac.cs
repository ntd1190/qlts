...
namespace SongAn.QLKD.Data.QLNS.PhuongXa
{
    public class GetListcbxPhuongXaByIdDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxPhuongXaByIdDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_PhuongXa_cbxPhuongXaByQuanId",
                    param: p,
