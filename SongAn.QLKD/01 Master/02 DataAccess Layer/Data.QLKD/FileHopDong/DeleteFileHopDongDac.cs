...
{
    public class DeleteFileHopDongDac : BaseRepositoryAsync
    {
        ...
        public DeleteFileHopDongDac(ContextDto context) : base(context.dbQLKDConnection)
        {
