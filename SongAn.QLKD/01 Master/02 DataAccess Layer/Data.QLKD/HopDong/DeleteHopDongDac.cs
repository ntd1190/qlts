...
{
    public class DeleteHopDongDac : BaseRepositoryAsync
    {
        #region public properties

        public virtual string HOPDONGIDS { get; set; }
        ...
        public DeleteHopDongDac(ContextDto context) : base(context.dbQLKDConnection)
        {
