...
{
    public class UpdateHopDongDac : BaseRepositoryAsync
    {
        #region public properties

        public virtual Entity.QLKD.Entity.KDHopDong HopDong { get; set; }
        ...
        public UpdateHopDongDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            {
                var p = new DynamicParameters(HopDong);
