...
namespace SongAn.QLKD.Data.QLNS.NhomKhachHang
{
    public class GetListcbxNhomKhachHangByIdDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxNhomKhachHangByIdDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_NhomKhachHang_cbxNhomKhachHangById",
                    param: p,
