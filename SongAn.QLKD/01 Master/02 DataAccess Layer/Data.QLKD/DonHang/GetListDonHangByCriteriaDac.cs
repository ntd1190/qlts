...
{
    public class GetListDonHangByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListDonHangByCriteriaDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_DonHang_GetListDonHangByCriteria",
                    param: p,
