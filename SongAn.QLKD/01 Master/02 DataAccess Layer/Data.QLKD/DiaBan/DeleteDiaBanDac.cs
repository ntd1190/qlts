...
{
    public class DeleteDiaBanDac : BaseRepositoryAsync
    {
        #region public properties

        public virtual string DIABANIDS { get; set; }
        ...
        public DeleteDiaBanDac(ContextDto context) : base(context.dbQLKDConnection)
        {
