...
namespace SongAn.QLKD.Data.QLKD.DuLieu
{
    public class InsertDuLieuDac : BaseRepositoryAsync
    {
        #region public properties

        public virtual Entity.QLKD.Entity.KDDuLieu DuLieu { get; set; }
        ...
        public InsertDuLieuDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            {
                var p = new DynamicParameters(DuLieu);
