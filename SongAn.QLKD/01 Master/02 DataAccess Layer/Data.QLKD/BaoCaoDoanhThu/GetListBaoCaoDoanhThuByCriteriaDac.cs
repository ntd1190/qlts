...
namespace SongAn.QLKD.Data.QLKD.BaoCaoDoanhThu
{
    public class GetListBaoCaoDoanhThuByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListBaoCaoDoanhThuByCriteriaDac(ContextDto context) : base(context.dbQLKDConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("SearchLoaiHopDongId", SearchLoaiHopDongId, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KD_BaoCaoDoanhThu_GetListBaoCaoDoanhThuByCriteria",
                    param: p,
