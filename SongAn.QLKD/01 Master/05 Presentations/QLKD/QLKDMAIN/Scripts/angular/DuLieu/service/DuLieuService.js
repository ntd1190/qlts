(function () {
    ...
    module.factory('DuLieuService', function ($http, API_BASE) {
        var api = {};
        api.url = API_BASE + 'Api.QLKD/DuLieu/';

        api.insert = 'InsertDuLieu';
        api.delete = 'DeleteDuLieu';
        api.update = 'UpdateDuLieu';
