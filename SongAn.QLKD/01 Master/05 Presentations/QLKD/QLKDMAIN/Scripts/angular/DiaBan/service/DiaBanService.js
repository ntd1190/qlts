(function () {
    ...
    module.factory('DiaBanService', function ($http, API_BASE) {
        var api = {};
        api.url = API_BASE + 'Api.QLKD/DiaBan/';

        api.insert = 'InsertDiaBan';
        api.delete = 'DeleteDiaBan';
        api.update = 'UpdateDiaBan';
