...
using SongAn.QLKD.Api.QLKDAPI.Formats;
using SongAn.QLKD.Api.QLKDAPI.Providers;
using QLKDAPI;
using System.Configuration;

[assembly: OwinStartup(typeof(SongAn.QLKD.Api.QLKDAPI.Startup))]

namespace SongAn.QLKD.Api.QLKDAPI
{
