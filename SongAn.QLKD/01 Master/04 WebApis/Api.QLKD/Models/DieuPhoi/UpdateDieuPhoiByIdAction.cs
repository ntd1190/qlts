...
{
    public class UpdateDieuPhoiByIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                if (_DieuPhoiId < 1)
                {
                    return returnActionError(HttpStatusCode.BadRequest, "Không tìm thấy _DieuPhoiId");
                }

                var bizHeader = new UpdateDieuPhoiByIdBiz(context);

                bizHeader.DieuPhoiId = Protector.Int(_DieuPhoiId);
        ...
        private void init()
        {
            ...
            _DieuPhoiId = Protector.Int(dieuPhoiId, 0);
        }
