...
{
    public class GetListDieuPhoiChiTietByDieuPhoiIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            ...
            try
            {
                ...
                /* convert input */
                GetListDieuPhoiChiTietByDieuPhoiIdBiz biz = new GetListDieuPhoiChiTietByDieuPhoiIdBiz(context);
        ...
        private dynamic validate()
        {
            ...
            var _DonHangId = Protector.Int(DonHangId);

            if (_error.code == 0 && _DieuPhoiId < 1 && _DonHangId < 1)
            {
                _error.code = 1;
