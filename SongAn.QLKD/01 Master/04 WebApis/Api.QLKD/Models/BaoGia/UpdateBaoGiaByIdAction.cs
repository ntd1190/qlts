...
{
    public class UpdateBaoGiaByIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                if (_BaoGiaId < 1)
                {
                    return returnActionError(HttpStatusCode.BadRequest, "Không tìm thấy _BaoGiaId");
                }

                var bizHeader = new UpdateBaoGiaByIdBiz(context);

                bizHeader.BaoGiaId = Protector.Int(_BaoGiaId);
        ...
        private void init()
        {
            ...
            _BaoGiaId = Protector.Int(BaoGiaId, 0);
        }
