...
{
    public class GetListBaoGiaByProjectionAction
    {
        ...
        {
            GetListBaoGiaByCriteriaBiz biz = new GetListBaoGiaByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "BaoGiaId" : sortName;
                ...
                IEnumerable<dynamic> listBaoGia = await biz.Execute();
                if (listBaoGia.Count() > 0)
                {
                    var obj = listBaoGia.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listBaoGia, _metaData);
            }
            catch (Exception ex)
            {
