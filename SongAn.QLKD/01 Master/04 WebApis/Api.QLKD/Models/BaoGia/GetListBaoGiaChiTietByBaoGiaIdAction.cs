...
{
    public class GetListBaoGiaChiTietByBaoGiaIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            ...
            try
            {
                ...
                /* convert input */
                GetListBaoGiaChiTietByBaoGiaIdBiz biz = new GetListBaoGiaChiTietByBaoGiaIdBiz(context);
        ...
        private dynamic validate()
        {
            ...
            var _BaoGiaIdId = Protector.Int(BaoGiaId);

            if (_error.code == 0 && _BaoGiaIdId < 1)
            {
                _error.code = 1;
