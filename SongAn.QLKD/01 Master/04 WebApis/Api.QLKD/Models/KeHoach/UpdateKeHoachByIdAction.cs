...
{
    public class UpdateKeHoachByIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                if (_keHoachId < 1)
                {
                    return returnActionError(HttpStatusCode.BadRequest, "Không tìm thấy _keHoachId");
                }

                var bizHeader = new UpdateKeHoachByIdBiz(context);

                bizHeader.KeHoachId = _keHoachId;
        ...
        private void init()
        {
            ...
            //////////////////////////////////////////////////////////////////////////
            _UserId = Protector.String(loginId);
            _keHoachId = Protector.Int(keHoachId, 0);
        }
