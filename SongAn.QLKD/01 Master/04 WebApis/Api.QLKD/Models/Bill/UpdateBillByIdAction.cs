...
{
    public class UpdateBillByIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                if (_BillId < 1)
                {
                    return returnActionError(HttpStatusCode.BadRequest, "Không tìm thấy _BillId");
                }

                var bizHeader = new UpdateBillByIdBiz(context);

                bizHeader.BillId = Protector.Int(_BillId);
        ...
        private void init()
        {
            ...
            _BillId = Protector.Int(BillId, 0);
        }
