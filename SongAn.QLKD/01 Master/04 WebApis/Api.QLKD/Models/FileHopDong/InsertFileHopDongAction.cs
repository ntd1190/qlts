...
{
    public class InsertFileHopDongAction : Entity.QLKD.Entity.KDFileHopDong
    {
        #region public
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                var biz = new InsertFileHopDongBiz(context);
                ...
                biz.FileHopDong.NgayChuyen = NgayChuyen;
                biz.FileHopDong.NguoiNhan = Protector.String(NguoiNhan, "");
                biz.FileHopDong.NgayNhan = NgayNhan;
                biz.FileHopDong.FileMem = Protector.String(FileMem, "");
                biz.FileHopDong.FileCung = Protector.String(FileMem, "");
