...
{
    public class DeleteLoaiHopDongAction
    {
        #region public
        public virtual string LOAIHOPDONGIDS { get; set; }
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                var biz = new DeleteLoaiHopDongBiz(context);

                biz.LOAIHOPDONGIDS = Protector.String(LOAIHOPDONGIDS);
