...
{
    public class UpdateChiTieuByIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                if (_ChiTieuId < 1)
                {
                    return returnActionError(HttpStatusCode.BadRequest, "Không tìm thấy _ChiTieuId");
                }

                var bizHeader = new UpdateChiTieuByIdBiz(context);

                bizHeader.ChiTieuId = Protector.Int(_ChiTieuId);
        ...
        private void init()
        {
            ...
            _ChiTieuId = Protector.Int(chiTieuid, 0);
        }
