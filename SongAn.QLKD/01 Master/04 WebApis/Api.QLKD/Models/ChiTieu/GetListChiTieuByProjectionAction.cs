...
{
    public class GetListChiTieuByProjectionAction
    {
        ...
        {
            GetListChiTieuByCriteriaBiz biz = new GetListChiTieuByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "ChiTieuId" : sortName;
                ...
                IEnumerable<dynamic> listChiTieu = await biz.Execute();
                if (listChiTieu.Count() > 0)
                {
                    var obj = listChiTieu.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listChiTieu, _metaData);
            }
            catch (Exception ex)
            {
