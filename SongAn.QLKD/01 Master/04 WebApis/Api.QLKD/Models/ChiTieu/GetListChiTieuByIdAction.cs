...
{
    public class GetListChiTieuByIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            ...
            try
            {
                ...
                /* convert input */
                GetListChiTieuByIdBiz biz = new GetListChiTieuByIdBiz(context);
        ...
        private dynamic validate()
        {
            ...
            var _ChiTieuId = Protector.Int(ChiTieuId);

            if (_error.code == 0 && _ChiTieuId < 1)
            {
                _error.code = 1;
