...
{
    public class GetListcbxNhomKhachHangByIdAction
    {
        ...
        {
            GetListcbxNhomKhachHangByIdBiz biz = new GetListcbxNhomKhachHangByIdBiz(context);
            ...
            try
            {
                ...
                biz.NhomKhachHangId = Protector.Int(NhomKhachHangId);
