...
namespace SongAn.QLKD.Biz.Main.NguoiDung
{
    public class GetListcbxNguoiDungByIdBiz : SongAn.QLKD.Data.Main.NguoiDung.GetListcbxNguoiDungByIdDac
    {
        ...
        public GetListcbxNguoiDungByIdBiz(ContextDto context) : base(context)
        {
