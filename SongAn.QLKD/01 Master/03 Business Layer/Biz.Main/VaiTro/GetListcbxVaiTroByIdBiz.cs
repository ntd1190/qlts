...
namespace SongAn.QLKD.Biz.Main.VaiTro
{
    public class GetListcbxVaiTroByIdBiz : SongAn.QLKD.Data.Main.VaiTro.GetListcbxVaiTroByIdDac
    {
        ...
        public GetListcbxVaiTroByIdBiz(ContextDto context) : base(context)
        {
