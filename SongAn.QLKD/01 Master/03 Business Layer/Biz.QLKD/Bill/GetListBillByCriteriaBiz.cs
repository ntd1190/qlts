using SongAn.QLKD.Data.QLKD.Bill;
...
namespace SongAn.QLKD.Biz.QLKD.Bill
{
    public class GetListBillByCriteriaBiz : GetListBillByCriteriaDac
    {
        ...
        public GetListBillByCriteriaBiz(ContextDto context) : base(context)
        {
