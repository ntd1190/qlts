...
using SongAn.QLKD.Data.QLNS.PhuongXa;

namespace SongAn.QLKD.Biz.QLKD.PhuongXa
{
    public class GetListcbxPhuongXaByIdBiz : GetListcbxPhuongXaByIdDac
    {
        ...
        public GetListcbxPhuongXaByIdBiz(ContextDto context) : base(context)
        {
