...
3. Function     : QLKDMAIN/chucvu/update
4. Description  : Goi dac update chuc vu
...
namespace SongAn.QLKD.Biz.QLKD.ChucVu
{
    /// <summary>
    ...
    /// </remarks>
    public class UpdateXoaListChucVuBiz : SongAn.QLKD.Data.QLKD.ChucVu.UpdateXoaListChucVuDac
    {
        ...
        public UpdateXoaListChucVuBiz(ContextDto context) : base(context)
        {
