...
namespace SongAn.QLKD.Biz.QLKD.ChucVu
{
    ...
    /// </remarks>
    public class GetListChucVuByCriteriaBiz : SongAn.QLKD.Data.QLKD.ChucVu.GetListChucVuByCriteriaDac
    {
        ...
        public GetListChucVuByCriteriaBiz(ContextDto context) : base(context)
        {
