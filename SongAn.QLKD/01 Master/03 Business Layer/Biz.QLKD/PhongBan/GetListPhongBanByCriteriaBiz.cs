...
3. Function     : QLKDMAIN/NghiPhep/List
...
namespace SongAn.QLKD.Biz.QLKD.PhongBan
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListPhongBanByCriteriaBiz : SongAn.QLKD.Data.QLKD.PhongBan.GetListPhongBanSelectAllByCriteriaProjectionDac
    {
        ...
        public GetListPhongBanByCriteriaBiz(ContextDto context) : base(context)
        {
