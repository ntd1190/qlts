...
{
    public class GetListDieuPhoiChiTietByDieuPhoiIdBiz : GetListDieuPhoiChiTietByDieuPhoiIdDac
    {
        ...
        public GetListDieuPhoiChiTietByDieuPhoiIdBiz(ContextDto context) : base(context)
        {
