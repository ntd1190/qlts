using SongAn.QLKD.Data.QLKD.LoaiHopDong;
using SongAn.QLKD.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLKD.Biz.QLKD.LoaiHopDong
{
    public class cbxGetListByCriteriaBiz : cbxGetListByCriteriaDac
    {
        ...
        public cbxGetListByCriteriaBiz(ContextDto context) : base(context)
        {
