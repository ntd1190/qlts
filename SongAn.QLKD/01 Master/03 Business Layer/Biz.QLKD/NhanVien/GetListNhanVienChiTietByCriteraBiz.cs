using SongAn.QLKD.Data.QLKD.NhanVien;
...
{
    public class GetListNhanVienChiTietByCriteraBiz : GetListNhanVienChiTietByProjectionDac
    {
        ...
        public GetListNhanVienChiTietByCriteraBiz(ContextDto context) : base(context)
        {
