using SongAn.QLKD.Data.QLKD.FileHopDong;
using SongAn.QLKD.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLKD.Biz.QLKD.FileHopDong
{
    public class DeleteFileHopDongBiz : DeleteFileHopDongDac
    {
        ...
        public DeleteFileHopDongBiz(ContextDto context) : base(context)
        {
