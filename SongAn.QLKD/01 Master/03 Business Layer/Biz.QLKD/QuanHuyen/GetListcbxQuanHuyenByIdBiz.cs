...
using SongAn.QLKD.Data.QLNS.QuanHuyen;

namespace SongAn.QLKD.Biz.QLKD.QuanHuyen
{
    public class GetListcbxQuanHuyenByIdBiz : GetListcbxQuanHuyenByIdDac
    {
        ...
        public GetListcbxQuanHuyenByIdBiz(ContextDto context) : base(context)
        {
