...
using SongAn.QLKD.Data.QLNS.Tinh;

namespace SongAn.QLKD.Biz.QLKD.Tinh
{
    public class GetListcbxTinhByIdBiz : GetListcbxTinhByIdDac
    {
        ...
        public GetListcbxTinhByIdBiz(ContextDto context) : base(context)
        {
