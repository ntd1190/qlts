using SongAn.QLKD.Data.QLKD.HopDong;
using SongAn.QLKD.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLKD.Biz.QLKD.HopDong
{
    public class GetListChiTietByCriteriaBiz : GetListChiTietByCriteriaDac
    {
        ...
        public GetListChiTietByCriteriaBiz(ContextDto context) : base(context)
        {
