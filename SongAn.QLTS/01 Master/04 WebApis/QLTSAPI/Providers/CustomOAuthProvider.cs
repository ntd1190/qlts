...
using SongAn.QLTS.Data.Main;
using SongAn.QLTS.Data.Main.PhanQuyen;
using SongAn.QLTS.Data.Main.PhanQuyen.Dto;
...
namespace SongAn.QLTS.Api.QLTSAPI.Providers
{
    ...
    public class CustomOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var CoSoId = objNguoiDung.CoSoId != null ? objNguoiDung.CoSoId.Value.ToString() : "";
            identity.AddClaim(new Claim("CoSoId", CoSoId));
