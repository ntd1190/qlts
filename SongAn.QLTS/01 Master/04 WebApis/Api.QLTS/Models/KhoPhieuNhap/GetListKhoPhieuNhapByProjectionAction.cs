...
{
    public class GetListKhoPhieuNhapByProjectionAction
    {
        ...
        {
            GetListKhoPhieuNhapByCriteriaBiz biz = new GetListKhoPhieuNhapByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "KhoPhieuNhapId" : sortName;
                ...
                IEnumerable<dynamic> listKhoPhieuNhap = await biz.Execute();
                if (listKhoPhieuNhap.Count() > 0)
                {
                    var obj = listKhoPhieuNhap.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listKhoPhieuNhap, _metaData);
            }
            catch (Exception ex)
            {
