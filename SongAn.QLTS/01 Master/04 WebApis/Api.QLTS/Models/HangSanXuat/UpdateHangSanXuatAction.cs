...
{
    public class UpdateHangSanXuatAction : SongAn.QLTS.Entity.QLTS.Entity.HangSanXuat
    {
        ...
        public async Task<dynamic> Execute(ContextDto context)
        {
            ...
            await repo.UpdatePartial(this,
                nameof(MaHangSanXuat),
                nameof(TenHangSanXuat),
                nameof(GhiChu)
                 );
            result.data = this;
        ...
        {
            var _id = Protector.Int(HangSanXuatId);

            if (_id < 1)
            {
                throw new FormatException("HangSanXuatId is empty");
            }
        }

        private void init()
        {
            _HangSanXuatId = Protector.Int(HangSanXuatId);
