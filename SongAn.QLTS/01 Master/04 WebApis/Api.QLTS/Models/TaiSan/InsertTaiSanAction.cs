...
{
    public class InsertTaiSanAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                int _taiSanId = result.FirstOrDefault().TaiSanId;
