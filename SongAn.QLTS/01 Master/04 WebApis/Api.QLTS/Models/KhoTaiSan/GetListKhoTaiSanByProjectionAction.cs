...
{
    public class GetListKhoTaiSanByProjectionAction
    {
        ...
        {
            GetListKhoTaiSanByCriteriaBiz biz = new GetListKhoTaiSanByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "KhoTaiSanId" : sortName;
                ...
                if (listKhoTaiSan.Count() > 0)
                {
                    var obj = listKhoTaiSan.FirstOrDefault();
