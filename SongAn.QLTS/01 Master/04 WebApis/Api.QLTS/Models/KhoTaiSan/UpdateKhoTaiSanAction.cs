...
{
    public class UpdateKhoTaiSanAction : SongAn.QLTS.Entity.QLTS.Entity.KhoTaiSan
    {
        private int _KhoTaiSanId;
        ...
        {
            var _id = Protector.Int(KhoTaiSanId);

            if (_id < 1)
            {
                throw new FormatException("KhoTaiSanId is empty");
            }
        }

        private void init()
        {
            _KhoTaiSanId = Protector.Int(KhoTaiSanId);
