...
{
    public class GetListDeNghiTrangCapChiTietByDeNghiIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            ...
            try
            {
                ...
                GetListDeNghiTrangCapChiTietByDeNghiIdBiz biz = new GetListDeNghiTrangCapChiTietByDeNghiIdBiz(context);
