...
{
    public class GetListTheoDoiByProjectionAction
    {
        ...
        {
            GetListTheoDoiByCriteriaBiz biz = new GetListTheoDoiByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "TaiSanId" : sortName;
                ...
                IEnumerable<dynamic> listTheoDoi = await biz.Execute();
                if (listTheoDoi.Count() > 0)
                {
                    var obj = listTheoDoi.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listTheoDoi, _metaData);
            }
            catch (Exception ex)
            {
