...
{
    public class InsertThayDoiThongTinNhaAction
    {
        ...
        private Entity.QLTS.Entity.ThongTinKeKhaiNha _TTKK { get; set; }
        #endregion
        ...
        private void init()
        {
            ...
            _TTKK = JsonConvert.DeserializeObject<Entity.QLTS.Entity.ThongTinKeKhaiNha>(TTKK);
        }
