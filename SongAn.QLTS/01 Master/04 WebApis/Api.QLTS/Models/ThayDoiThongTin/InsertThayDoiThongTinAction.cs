...
{
    public class InsertThayDoiThongTinAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                if (LoaiKeKhai == 1)
                {
                    var biz = new InsertThayDoiThongTinDatBiz(context);
                    biz.TDTT = _TDTT;
                ...
                if (LoaiKeKhai == 2)
                {
                    var biz = new InsertThayDoiThongTinNhaBiz(context);
                    biz.TDTT = _TDTT;
                    biz.TTKK_Nha = _TTKK_Nha;
                    biz.TenTaiSan = TenTaiSanMoi;
                    biz.CoSoId = CoSoId;
                    biz.NhanVienId = NhanVienId;
                ...
                if (LoaiKeKhai == 3)
                {
                    var biz = new InsertThayDoiThongTinOtoBiz(context);
                    biz.TDTT = _TDTT;
                ...
                if (LoaiKeKhai == 4)
                {
                    var biz = new InsertThayDoiThongTin500Biz(context);
                    biz.TDTT = _TDTT;
