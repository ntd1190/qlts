...
{
    public class InsertThayDoiThongTin500Action
    {
        ...
        private Entity.QLTS.Entity.ThongTinKeKhaiTren500 _TTKK { get; set; }
        #endregion
        ...
        private void init()
        {
            ...
            _TTKK = JsonConvert.DeserializeObject<Entity.QLTS.Entity.ThongTinKeKhaiTren500>(TTKK);
        }
