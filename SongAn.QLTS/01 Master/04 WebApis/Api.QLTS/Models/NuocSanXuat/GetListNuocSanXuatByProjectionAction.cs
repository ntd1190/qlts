...
{
    public class GetListNuocSanXuatByProjectionAction
    {
        ...
        {
            GetListNuocSanXuatByCriteriaBiz biz = new GetListNuocSanXuatByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "NuocSanXuatId" : sortName;
                ...
                if (listNuocSanXuat.Count() > 0)
                {
                    var obj = listNuocSanXuat.FirstOrDefault();
