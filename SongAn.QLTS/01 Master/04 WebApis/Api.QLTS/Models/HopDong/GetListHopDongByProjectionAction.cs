...
{
    public class GetListHopDongByProjectionAction
    {
        ...
        {
            GetListHopDongByCriteriaBiz biz = new GetListHopDongByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "HopDongId" : sortName;
                ...
                {
                    var obj = listHopDong.FirstOrDefault();
