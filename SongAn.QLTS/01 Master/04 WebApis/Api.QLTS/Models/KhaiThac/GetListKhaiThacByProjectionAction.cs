...
{
    public class GetListKhaiThacByProjectionAction
    {
        ...
        {
            GetListKhaiThacByCriteriaBiz biz = new GetListKhaiThacByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "KhaiThacId" : sortName;
                ...
                IEnumerable<dynamic> listKhaiThac = await biz.Execute();
                if (listKhaiThac.Count() > 0)
                {
                    var obj = listKhaiThac.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listKhaiThac, _metaData);
            }
            catch (Exception ex)
            {
