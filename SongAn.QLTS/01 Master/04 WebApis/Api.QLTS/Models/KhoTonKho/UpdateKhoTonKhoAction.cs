...
{
    public class UpdateKhoTonKhoAction : SongAn.QLTS.Entity.QLTS.Entity.KhoTonKho
    {
        private int _KhoTonKhoId;
        ...
        {
            var _id = Protector.Int(KhoTonKhoId);

            if (_id < 1)
            {
                throw new FormatException("KhoTonKhoId is empty");
            }
        }

        private void init()
        {
            _KhoTonKhoId = Protector.Int(KhoTonKhoId);
