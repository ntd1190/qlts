...
{
    public class GetListSuaChuaByBaoDuongIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            ...
            try
            {
                ...
                GetListSuaChuaByBaoDuongIdBiz biz = new GetListSuaChuaByBaoDuongIdBiz(context);
                biz.BaoDuongId = Protector.String(BaoDuongId);

                IEnumerable<dynamic> SuaChua = await biz.Execute();
