...
{
    public class GetListGhiTangChiTietByGhiTangIdAction
    {
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            ...
            try
            {
                ...
                GetListGhiTangChiTietByGhiTangIdBiz biz = new GetListGhiTangChiTietByGhiTangIdBiz(context);
                biz.GhiTangId = Protector.String(GhiTangId);

                IEnumerable<dynamic> GhiTangChiTiet = await biz.Execute();

                if (GhiTangChiTiet == null)
                {
