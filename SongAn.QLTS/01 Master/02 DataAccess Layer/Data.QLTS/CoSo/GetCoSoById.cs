...
namespace SongAn.QLTS.Data.QLTS.CoSo
{
    ...
    /// </summary>
    public class GetCoSoById : BaseRepositoryAsync
    {
        #region public properties

        /// <summary>
        /// Danh sách các CoSoId cần lấy
        /// </summary>
        ...
        public GetCoSoById(ContextDto context) : base(context.dbQLTSConnection)
        {
