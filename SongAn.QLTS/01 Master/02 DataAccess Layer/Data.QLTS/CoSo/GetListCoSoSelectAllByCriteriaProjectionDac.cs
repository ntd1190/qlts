...
namespace SongAn.QLTS.Data.QLTS.CoSo
{
    ...
    /// </summary>
    public class GetListCoSoSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListCoSoSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_CoSo_GetListCoSoByCriteria",
                    param: p,
