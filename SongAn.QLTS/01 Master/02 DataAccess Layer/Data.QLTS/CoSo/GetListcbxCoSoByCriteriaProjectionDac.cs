...
namespace SongAn.QLTS.Data.QLTS.CoSo
{
    ...
    /// </summary>
    public class GetListcbxCoSoByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxCoSoByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
