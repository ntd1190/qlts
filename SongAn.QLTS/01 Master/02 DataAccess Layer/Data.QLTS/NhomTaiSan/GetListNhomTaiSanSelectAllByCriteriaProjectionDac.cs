...
3. Function     : QLDNMAIN/NhomTaiSan/NhomTaiSan
...
namespace SongAn.QLTS.Data.QLTS.NhomTaiSan
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListNhomTaiSanSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListNhomTaiSanSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NhomTaiSan_GetListNhomTaiSanByCriteria",
                    param: p,
