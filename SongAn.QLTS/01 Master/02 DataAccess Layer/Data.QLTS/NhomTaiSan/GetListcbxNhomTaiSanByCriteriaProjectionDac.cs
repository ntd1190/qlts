...
namespace SongAn.QLTS.Data.QLTS.NhomTaiSan
{
    ...
    /// </summary>
    public class GetListcbxNhomTaiSanByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxNhomTaiSanByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NhomTaiSan_cbxNhomTaiSanByCriteria",
                    param: p,
