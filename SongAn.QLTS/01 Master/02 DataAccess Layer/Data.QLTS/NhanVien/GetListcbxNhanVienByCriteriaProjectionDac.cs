...
namespace SongAn.QLTS.Data.QLTS.NhanVien
{
    ...
    /// </summary>
    public class GetListcbxNhanVienByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxNhanVienByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NhanVien_cbxNhanVienByCriteria",
                    param: p,
