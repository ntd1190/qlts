...
{
    public class UpdateNhanVienByIdDac : BaseRepositoryAsync
    {
        ...
        public UpdateNhanVienByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NhanVien_UpdateNhanVien",
                    param: p,
