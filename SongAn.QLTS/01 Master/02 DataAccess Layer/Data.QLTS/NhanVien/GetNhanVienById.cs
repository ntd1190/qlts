...
namespace SongAn.QLTS.Data.QLTS.NhanVien
{
    ...
    /// </summary>
    public class GetNhanVienById : BaseRepositoryAsync
    {
        #region public properties

        /// <summary>
        /// Danh sách các NhanVienId cần lấy
        /// </summary>
        ...
        public GetNhanVienById(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NhanVien_GetNhanVienById",
                    param: p,
