...
{
    public class GetListGiayBaoHongByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListGiayBaoHongByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_GiayBaoHong_GetListGiayBaoHongByCriteria",
                    param: p,
