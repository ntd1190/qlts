...
3. Function     : QLDNMAIN/NuocSanXuat/NuocSanXuat
...
namespace SongAn.QLTS.Data.QLTS.NuocSanXuat
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListNuocSanXuatSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListNuocSanXuatSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NuocSanXuat_GetListNuocSanXuatByCriteria",
                    param: p,
