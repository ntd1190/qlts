...
namespace SongAn.QLTS.Data.QLTS.KhachHang
{
    ...
    /// </summary>
    public class GetListcbxKhachHangByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxKhachHangByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhachHang_cbxKhachHangByCriteria",
                    param: p,
