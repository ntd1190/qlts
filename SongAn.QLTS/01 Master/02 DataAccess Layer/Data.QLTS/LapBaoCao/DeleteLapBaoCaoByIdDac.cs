...
namespace SongAn.QLTS.Data.QLTS.LapBaoCao
{
    ...
    /// </summary>
    public class DeleteLapBaoCaoByIdDac : BaseRepositoryAsync
    {
        ...
        public DeleteLapBaoCaoByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_LapBaoCao_DeleteLapBaoCaoById",
                    param: p,
