...
namespace SongAn.QLTS.Data.QLTS.LapBaoCao
{
    ...
    /// </summary>
    public class GetLapBaoCaoByIdDac : BaseRepositoryAsync
    {
        ...
        public GetLapBaoCaoByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_LapBaoCao_GetLapBaoCaoById",
                    param: p,
