...
3. Function     : QLDNMAIN/LapBaoCao/LapBaoCao
...
namespace SongAn.QLTS.Data.QLTS.LapBaoCao
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListLapBaoCaoByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListLapBaoCaoByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_LapBaoCao_GetListLapBaoCaoByCriteria",
                    param: p,
