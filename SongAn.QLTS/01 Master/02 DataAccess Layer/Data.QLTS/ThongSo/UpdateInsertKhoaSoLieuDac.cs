...
namespace SongAn.QLTS.Data.QLTS.ThongSo
{
    ...
    /// </summary>
    public class UpdateInsertKhoaSoLieuDac : BaseRepositoryAsync
    {
        #region public properties

        public int KhoaSoLieuId { get; set; }
        ...
        public UpdateInsertKhoaSoLieuDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoaSoLieu_UpdateInsert",
                    param: p,
