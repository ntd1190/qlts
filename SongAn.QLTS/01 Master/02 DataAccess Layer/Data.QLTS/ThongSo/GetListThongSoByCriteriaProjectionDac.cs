...
namespace SongAn.QLTS.Data.QLTS.ThongSo
{
    ...
    /// </summary>
    public class GetListThongSoByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListThongSoByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
