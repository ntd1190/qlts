...
namespace SongAn.QLTS.Data.QLTS.KhoTaiSan
{
    ...
    /// </summary>
    public class GetListcbxKhoTaiSanByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxKhoTaiSanByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
