...
namespace SongAn.QLTS.Data.QLTS.KhoTaiSan
{
    ...
    /// </summary>
    public class GetListKhoTaiSanSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoTaiSanSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoTaiSan_GetListKhoTaiSanByCriteria",
                    param: p,
