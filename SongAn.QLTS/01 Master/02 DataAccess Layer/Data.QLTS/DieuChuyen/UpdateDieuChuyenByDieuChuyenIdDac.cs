...
namespace SongAn.QLTS.Data.QLTS.DieuChuyen
{
    public class UpdateDieuChuyenByDieuChuyenIdDac : BaseRepositoryAsync
    {
        ...
        public UpdateDieuChuyenByDieuChuyenIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
