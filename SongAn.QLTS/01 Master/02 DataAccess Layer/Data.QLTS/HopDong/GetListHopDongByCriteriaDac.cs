...
{
    public class GetListHopDongByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListHopDongByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_HopDong_GetListHopDongByCriteria",
                    param: p,
