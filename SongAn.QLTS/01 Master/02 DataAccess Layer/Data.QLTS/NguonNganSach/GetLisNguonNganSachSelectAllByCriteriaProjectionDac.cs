...
3. Function     : QLDNMAIN/NguonNganSach/NguonNganSach
...
namespace SongAn.QLTS.Data.QLTS.NguonNganSach
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListNguonNganSachSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListNguonNganSachSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NguonNganSach_GetListNguonNganSachByCriteria",
                    param: p,
