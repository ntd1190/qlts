...
{
    public class ReportCongKhaiTinhHinhXuLyTSBieu06Dac : BaseRepositoryDataset
    {
        ...
        public ReportCongKhaiTinhHinhXuLyTSBieu06Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoCongKhaiTinhHinhXuLyTSBieu06", prm);
            return ds;
