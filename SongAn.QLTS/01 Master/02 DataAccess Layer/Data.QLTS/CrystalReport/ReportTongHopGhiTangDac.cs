...
{
    public class ReportTongHopGhiTangDac : BaseRepositoryDataset
    {
        ...
        public ReportTongHopGhiTangDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoTongHopGhiTang", prm);
            return ds;
