...
{
    public class ReportCongKhaiKetQuaMuaSamTSNNBieu02Dac : BaseRepositoryDataset
    {
        ...
        public ReportCongKhaiKetQuaMuaSamTSNNBieu02Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoCongKhaiKetQuaMuaSamTSNNBieu02", prm);
            return ds;
