...
{
    public class ReportTongHopTaiSanCoDinhDac : BaseRepositoryDataset
    {
        ...
        public ReportTongHopTaiSanCoDinhDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoTongHopTaiSanCoDinh", prm);
            return ds;
