...
{
    public class ReportTaiSanKeKhai500Dac : BaseRepositoryDataset
    {
        ...
        public ReportTaiSanKeKhai500Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_TaiSan_report_KeKhai500", prm);
            return ds;
