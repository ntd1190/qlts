...
{
    public class ReportCongKhaiNhaDatBieu03Dac : BaseRepositoryDataset
    {
        ...
        public ReportCongKhaiNhaDatBieu03Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_CongKhai_report_NhaDatBieu03", prm);
            return ds;
