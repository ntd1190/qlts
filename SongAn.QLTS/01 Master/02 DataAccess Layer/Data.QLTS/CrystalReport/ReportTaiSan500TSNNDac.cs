...
{
    public class ReportTaiSan500TSNNDac : BaseRepositoryDataset
    {
        ...
        public ReportTaiSan500TSNNDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_TaiSan_report_500_TSNN", prm);
            return ds;
