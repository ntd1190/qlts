...
{
    public class ReportTaiSanOtoTSNNDac : BaseRepositoryDataset
    {
        ...
        public ReportTaiSanOtoTSNNDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_TaiSan_report_Oto_TSNN", prm);
            return ds;
