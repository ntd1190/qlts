...
{
    public class ReportTaiSanNhaDatTSNNDac : BaseRepositoryDataset
    {
        ...
        public ReportTaiSanNhaDatTSNNDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_TaiSan_report_NhaDat_TSNN", prm);
            return ds;
