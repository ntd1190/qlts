...
{
    public class ReportTongHopGhiGiamDac : BaseRepositoryDataset
    {
        ...
        public ReportTongHopGhiGiamDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoTongHopGhiGiam", prm);
            return ds;
