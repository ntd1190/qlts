...
{
    public class ReportTongHopTangGiamTSCDDac : BaseRepositoryDataset
    {
        ...
        public ReportTongHopTangGiamTSCDDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoTongHopTinhHinhTangGiamTSCD", prm);
            return ds;
