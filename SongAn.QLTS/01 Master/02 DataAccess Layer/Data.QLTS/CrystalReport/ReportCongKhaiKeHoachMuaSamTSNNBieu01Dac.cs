...
{
    public class ReportCongKhaiKeHoachMuaSamTSNNBieu01Dac : BaseRepositoryDataset
    {
        ...
        public ReportCongKhaiKeHoachMuaSamTSNNBieu01Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoCongKhaiKeHoachMuaSamTSNNBieu01", prm);
            return ds;
