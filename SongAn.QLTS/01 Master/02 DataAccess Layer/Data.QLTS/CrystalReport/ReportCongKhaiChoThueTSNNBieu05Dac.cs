...
{
    public class ReportCongKhaiChoThueTSNNBieu05Dac : BaseRepositoryDataset
    {
        ...
        public ReportCongKhaiChoThueTSNNBieu05Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual DataSet ExecuteDac()
        {
            ...
            DataSet ds = getData("sp_BaoCao_BaoCaoCongKhaiChoThueTSNNBieu05", prm);
            return ds;
