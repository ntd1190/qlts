...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class UpdateThayDoiThongTinDatDac : BaseRepositoryAsync
    {
        ...
        public UpdateThayDoiThongTinDatDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTinDat_UpdateThayDoiThongTinDat",
                    param: p,
