...
3. Function     : 
4. Description  : 
5. History      : 2017.09.18 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using Dapper;
...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class DeleteThayDoiThongTinDac : BaseRepositoryAsync
    {
        ...
        public DeleteThayDoiThongTinDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTin_DeleteThayDoiThongTin",
                    param: p,
