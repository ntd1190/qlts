...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class GetThayDoiThongTinNhaByIdDac : BaseRepositoryAsync
    {
        ...
        public GetThayDoiThongTinNhaByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTinNha_GetThayDoiThongTinNhaById",
                    param: p,
