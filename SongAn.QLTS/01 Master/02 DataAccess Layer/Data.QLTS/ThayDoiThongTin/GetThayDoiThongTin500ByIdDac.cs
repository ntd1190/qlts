...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class GetThayDoiThongTin500ByIdDac : BaseRepositoryAsync
    {
        ...
        public GetThayDoiThongTin500ByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTin500_GetThayDoiThongTin500ById",
                    param: p,
