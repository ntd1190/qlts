...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class UpdateThayDoiThongTinOtoDac : BaseRepositoryAsync
    {
        #region public properties
        public virtual Entity.QLTS.Entity.ThongTinKeKhaiOto TTKK_Oto { get; set; }
        ...
        public UpdateThayDoiThongTinOtoDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            {
                var p = new DynamicParameters(TTKK_Oto);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTinOto_UpdateThayDoiThongTinOto",
                    param: p,
