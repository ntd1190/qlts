...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class GetListThayDoiThongTinByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListThayDoiThongTinByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTin_GetListThayDoiThongTinByCriteria",
                    param: p,
