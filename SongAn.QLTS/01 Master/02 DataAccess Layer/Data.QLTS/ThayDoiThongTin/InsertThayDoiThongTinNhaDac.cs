...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class InsertThayDoiThongTinNhaDac : BaseRepositoryAsync
    {
        ...
        public InsertThayDoiThongTinNhaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTinNha_InsertThayDoiThongTinNha",
                    param: p,
