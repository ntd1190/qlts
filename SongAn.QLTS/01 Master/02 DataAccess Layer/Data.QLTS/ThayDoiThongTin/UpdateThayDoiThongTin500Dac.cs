...
3. Function     : 
4. Description  : 
5. History      : 2017.09.15 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using Dapper;
...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class UpdateThayDoiThongTin500Dac : BaseRepositoryAsync
    {
        #region public properties
        public virtual Entity.QLTS.Entity.ThongTinKeKhaiTren500 TTKK_500 { get; set; }
        ...
        public UpdateThayDoiThongTin500Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            {
                var p = new DynamicParameters(TTKK_500);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTin500_UpdateThayDoiThongTin500",
                    param: p,
