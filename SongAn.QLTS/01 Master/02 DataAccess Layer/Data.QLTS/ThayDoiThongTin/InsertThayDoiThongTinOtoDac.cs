...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class InsertThayDoiThongTinOtoDac : BaseRepositoryAsync
    {
        ...
        public InsertThayDoiThongTinOtoDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTinOto_InsertThayDoiThongTinOto",
                    param: p,
