...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class UpdateThayDoiThongTinNhaDac : BaseRepositoryAsync
    {
        ...
        public UpdateThayDoiThongTinNhaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTinNha_UpdateThayDoiThongTinNha",
                    param: p,
