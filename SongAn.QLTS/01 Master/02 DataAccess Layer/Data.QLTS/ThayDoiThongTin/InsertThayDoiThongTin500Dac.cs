...
namespace SongAn.QLTS.Data.QLTS.ThayDoiThongTin
{
    ...
    /// </summary>
    public class InsertThayDoiThongTin500Dac : BaseRepositoryAsync
    {
        ...
        public InsertThayDoiThongTin500Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThayDoiThongTin500_InsertThayDoiThongTin500",
                    param: p,
