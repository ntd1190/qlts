...
namespace SongAn.QLTS.Data.QLTS.KhoTonKho
{
    ...
    /// </summary>
    public class GetListKhoTonKhoByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoTonKhoByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoTonKho_GetListKhoTonKhoByCriteria",
                    param: p,
