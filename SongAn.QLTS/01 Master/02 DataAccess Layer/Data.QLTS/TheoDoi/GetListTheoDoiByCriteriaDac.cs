...
namespace SongAn.QLTS.Data.QLNS.TheoDoi
{
    public class GetListTheoDoiByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListTheoDoiByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_TheoDoi_GetListTheoDoiByCriteria",
                    param: p,
