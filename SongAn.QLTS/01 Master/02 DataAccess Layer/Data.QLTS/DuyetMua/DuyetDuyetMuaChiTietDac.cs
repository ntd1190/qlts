...
namespace SongAn.QLTS.Data.QLTS.DuyetMua
{
    ...
    /// </summary>
    public class DuyetDuyetMuaChiTietDac : BaseRepositoryAsync
    {
        ...
        public DuyetDuyetMuaChiTietDac(ContextDto context) : base(context.dbQLTSConnection)
        {
