...
3. Function     : QLDNMAIN/DuyetMua/DuyetMua
...
namespace SongAn.QLTS.Data.QLTS.DuyetMua
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListDuyetMuaByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListDuyetMuaByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("DuyetId", DuyetId, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DuyetMua_GetListDuyetMuaByCriteria",
                    param: p,
