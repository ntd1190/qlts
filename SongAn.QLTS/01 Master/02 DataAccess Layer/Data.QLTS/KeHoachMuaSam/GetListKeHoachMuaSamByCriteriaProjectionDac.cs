...
3. Function     : QLDNMAIN/KeHoachMuaSam/KeHoachMuaSam
...
namespace SongAn.QLTS.Data.QLTS.KeHoachMuaSam
{
    ...
    /// </summary>
    public class GetListKeHoachMuaSamByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKeHoachMuaSamByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KeHoachMuaSam_GetListKeHoachMuaSamByCriteria",
                    param: p,
