...
namespace SongAn.QLTS.Data.QLTS.HangSanXuat
{
    ...
    /// </summary>
    public class GetListHangSanXuatSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListHangSanXuatSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_HangSanXuat_GetListHangSanXuatByCriteria",
                    param: p,
