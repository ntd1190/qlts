...
{
    public class GetListBaoDuongByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListBaoDuongByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_BaoDuong_GetListBaoDuongByCriteria",
                    param: p,
