...
{
    public class UpdateBaoDuongByIdDac : BaseRepositoryAsync
    {
        ...
        public UpdateBaoDuongByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("CanBoId", CanBoId, DbType.Int32);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                        sql: "sp_BaoDuong_UpdateBaoDuong",
                        param: p,
