...
namespace SongAn.QLTS.Data.QLNS.DuyetCap
{
    public class GetListDuyetCapByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListDuyetCapByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DuyetCap_GetListDuyetCapByCriteria",
                    param: p,
