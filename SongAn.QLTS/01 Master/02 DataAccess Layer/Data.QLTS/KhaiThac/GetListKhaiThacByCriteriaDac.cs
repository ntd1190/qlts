...
{
    public class GetListKhaiThacByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListKhaiThacByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhaiThac_GetListKhaiThacByCriteria",
                    param: p,
