...
3. Function     : QLDNMAIN/GhiGiam/GhiGiam
...
namespace SongAn.QLTS.Data.QLTS.GhiGiam
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListGhiGiamByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListGhiGiamByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_GhiGiam_GetListGhiGiamByCriteria",
                    param: p,
