...
namespace SongAn.QLTS.Data.QLTS.GhiGiam
{
    ...
    /// </summary>
    public class DeleteGhiGiamByIdDac : BaseRepositoryAsync
    {
        ...
        public DeleteGhiGiamByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_GhiGiam_DeleteGhiGiamById",
                    param: p,
