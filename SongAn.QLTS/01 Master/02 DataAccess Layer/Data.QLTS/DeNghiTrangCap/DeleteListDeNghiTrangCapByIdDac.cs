...
{
    public class DeleteListDeNghiTrangCapByIdDac : BaseRepositoryAsync
    {
        ...
        public DeleteListDeNghiTrangCapByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
