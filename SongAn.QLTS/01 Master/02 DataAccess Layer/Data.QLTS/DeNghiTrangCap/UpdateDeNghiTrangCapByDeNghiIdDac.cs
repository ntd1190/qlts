...
{
    public class UpdateDeNghiTrangCapByDeNghiIdDac : BaseRepositoryAsync
    {
        ...
        public UpdateDeNghiTrangCapByDeNghiIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DeNghiTrangCap_UpdateDeNghiTrangCap",
                    param: p,
