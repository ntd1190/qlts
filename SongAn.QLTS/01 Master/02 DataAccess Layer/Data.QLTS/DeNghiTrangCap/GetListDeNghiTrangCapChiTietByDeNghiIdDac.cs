...
{
    public class GetListDeNghiTrangCapChiTietByDeNghiIdDac : BaseRepositoryAsync
    {
        ...
        public GetListDeNghiTrangCapChiTietByDeNghiIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
