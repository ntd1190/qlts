...
{
    public class GetListDeNghiTrangCapByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListDeNghiTrangCapByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
