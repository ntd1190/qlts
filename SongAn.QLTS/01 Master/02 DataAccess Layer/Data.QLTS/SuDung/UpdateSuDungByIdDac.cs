...
{
    public class UpdateSuDungByIdDac : BaseRepositoryAsync
    {
        ...
        public UpdateSuDungByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
