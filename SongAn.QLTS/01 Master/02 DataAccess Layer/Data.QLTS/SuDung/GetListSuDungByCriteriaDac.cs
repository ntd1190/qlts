...
{
    public class GetListSuDungByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListSuDungByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("KyLap", KyLap, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_SuDung_GetListSuDungByCriteria",
                    param: p,
