...
namespace SongAn.QLTS.Data.QLTS.NhaCungCap
{
    ...
    /// </summary>
    public class GetListNhaCungCapSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListNhaCungCapSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("NhaCungCapId", NhaCungCapId, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_NhaCungCap_GetListNhaCungCapByCriteria",
                    param: p,
