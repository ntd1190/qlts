...
namespace SongAn.QLTS.Data.QLTS.GhiGiamChiTiet
{
    ...
    /// </summary>
    public class GetGhiGiamChiTietByGhiGiamIdDac : BaseRepositoryAsync
    {
        ...
        public GetGhiGiamChiTietByGhiGiamIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_GhiGiamChiTiet_GetGhiGiamChiTietByGhiGiamId",
                    param: p,
