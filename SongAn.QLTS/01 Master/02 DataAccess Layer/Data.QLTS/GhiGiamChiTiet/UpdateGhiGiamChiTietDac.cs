...
namespace SongAn.QLTS.Data.QLTS.GhiGiamChiTiet
{
    ...
    /// </summary>
    public class UpdateGhiGiamChiTietDac : BaseRepositoryAsync
    {
        ...
        public UpdateGhiGiamChiTietDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_GhiGiamChiTiet_UpdateGhiGiamChiTietById",
                    param: p,
