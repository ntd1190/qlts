...
{
    public class GetListGhiTangByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListGhiTangByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_GhiTang_GetListGhiTangByCriteria",
                    param: p,
