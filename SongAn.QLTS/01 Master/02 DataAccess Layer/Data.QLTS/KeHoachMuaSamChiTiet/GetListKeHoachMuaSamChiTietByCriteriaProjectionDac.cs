...
namespace SongAn.QLTS.Data.QLTS.KeHoachMuaSamChiTiet
{
    ...
    /// </summary>
    public class GetListKeHoachMuaSamChiTietByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKeHoachMuaSamChiTietByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KeHoachMuaSamChiTiet_GetListKeHoachMuaSamChiTietByCriteria",
                    param: p,
