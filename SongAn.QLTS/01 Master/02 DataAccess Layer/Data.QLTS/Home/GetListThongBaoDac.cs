...
namespace SongAn.QLTS.Data.QLTS.Home
{
    public class GetListThongBaoDac : BaseRepositoryAsync
    {
        ...
        public GetListThongBaoDac(ContextDto context) : base(context.dbQLTSConnection)
        {
