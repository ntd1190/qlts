...
{
    public class GetListDanhGiaByCriteriaDac : BaseRepositoryAsync
    {
        #region public properties
        public virtual string Search { get; set; }
        public virtual string DanhGiaIds { get; set; }
        ...
        #region constructor
        public GetListDanhGiaByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DanhGia_GetListDanhGiaByCriteria",
                    param: p,
