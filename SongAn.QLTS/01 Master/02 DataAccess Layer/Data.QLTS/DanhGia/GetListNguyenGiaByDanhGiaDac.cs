...
{
    public class GetListNguyenGiaByDanhGiaDac : BaseRepositoryAsync
    {
        ...
        #region constructor
        public GetListNguyenGiaByDanhGiaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DanhGia_GetListNguyenGiaByDanhGia",
                    param: p,
