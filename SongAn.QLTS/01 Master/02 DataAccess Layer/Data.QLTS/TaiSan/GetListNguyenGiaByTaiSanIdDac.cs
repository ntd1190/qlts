...
{
    public class GetListNguyenGiaByTaiSanIdDac : BaseRepositoryAsync
    {
        ...
        #region constructor
        public GetListNguyenGiaByTaiSanIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_TaiSan_GetListNguyenGiaByTaiSanId",
                    param: p,
