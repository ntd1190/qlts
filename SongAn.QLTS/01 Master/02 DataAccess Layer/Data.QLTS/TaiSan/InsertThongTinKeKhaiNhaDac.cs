...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class InsertThongTinKeKhaiNhaDac : BaseRepositoryAsync
    {
        ...
        public InsertThongTinKeKhaiNhaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinKeKhaiNha_InsertThongTinKeKhaiNha",
                    param: p,
