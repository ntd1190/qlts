...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class InsertThongTinKeKhai500Dac : BaseRepositoryAsync
    {
        ...
        public InsertThongTinKeKhai500Dac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinKeKhai500_InsertThongTinKeKhai500",
                    param: p,
