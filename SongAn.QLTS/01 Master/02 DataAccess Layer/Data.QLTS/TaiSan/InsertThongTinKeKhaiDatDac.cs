...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class InsertThongTinKeKhaiDatDac : BaseRepositoryAsync
    {
        ...
        public InsertThongTinKeKhaiDatDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinKeKhaiDat_InsertThongTinKeKhaiDat",
                    param: p,
