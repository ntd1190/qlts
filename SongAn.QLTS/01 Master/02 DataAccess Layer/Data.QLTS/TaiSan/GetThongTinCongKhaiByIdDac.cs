...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class GetThongTinCongKhaiByIdDac : BaseRepositoryAsync
    {
        ...
        public GetThongTinCongKhaiByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinCongKhai_GetThongTinCongKhaiById",
                    param: p,
