...
3. Function     : 
4. Description  : 
5. History      : 2017.09.07 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using Dapper;
...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class InsertThongTinCongKhaiDac : BaseRepositoryAsync
    {
        #region public properties
        public virtual Entity.QLTS.Entity.ThongTinCongKhai ThongTinCongKhai { get; set; }
        ...
        public InsertThongTinCongKhaiDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            {
                var p = new DynamicParameters(ThongTinCongKhai);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinCongKhai_InsertThongTinCongKhai",
                    param: p,
