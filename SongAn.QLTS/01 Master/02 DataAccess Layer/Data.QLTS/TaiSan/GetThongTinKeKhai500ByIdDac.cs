...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class GetThongTinKeKhai500ByIdDac : BaseRepositoryAsync
    {
        ...
        public GetThongTinKeKhai500ByIdDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinKeKhai500_GetThongTinKeKhai500ById",
                    param: p,
