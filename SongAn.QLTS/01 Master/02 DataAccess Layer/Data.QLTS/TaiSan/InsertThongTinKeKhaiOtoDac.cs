...
namespace SongAn.QLTS.Data.QLTS.TaiSan
{
    ...
    /// </summary>
    public class InsertThongTinKeKhaiOtoDac : BaseRepositoryAsync
    {
        ...
        public InsertThongTinKeKhaiOtoDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ThongTinKeKhaiOto_InsertThongTinKeKhaiOto",
                    param: p,
