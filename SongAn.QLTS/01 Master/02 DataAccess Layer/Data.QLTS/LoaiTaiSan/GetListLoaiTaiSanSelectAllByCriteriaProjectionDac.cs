...
3. Function     : QLDNMAIN/LoaiTaiSan/LoaiTaiSan
...
namespace SongAn.QLTS.Data.QLTS.LoaiTaiSan
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListLoaiTaiSanSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListLoaiTaiSanSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_LoaiTaiSan_GetListLoaiTaiSanByCriteria",
                    param: p,
