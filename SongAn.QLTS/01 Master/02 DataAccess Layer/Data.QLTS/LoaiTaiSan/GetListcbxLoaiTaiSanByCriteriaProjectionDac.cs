...
namespace SongAn.QLTS.Data.QLTS.LoaiTaiSan
{
    ...
    /// </summary>
    public class GetListcbxLoaiTaiSanByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListcbxLoaiTaiSanByCriteriaProjectionDac(ContextDto context) : base(context.dbQLTSConnection)
        {
