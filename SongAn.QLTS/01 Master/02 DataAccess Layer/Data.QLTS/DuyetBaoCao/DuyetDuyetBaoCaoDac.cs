...
namespace SongAn.QLTS.Data.QLTS.DuyetBaoCao
{
    ...
    /// </summary>
    public class DuyetDuyetBaoCaoDac : BaseRepositoryAsync
    {
        ...
        public DuyetDuyetBaoCaoDac(ContextDto context) : base(context.dbQLTSConnection)
        {
