...
namespace SongAn.QLTS.Data.QLTS.DuyetBaoCao
{
    public class GetListDuyetBaoCaoByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListDuyetBaoCaoByCriteriaDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DuyetBaoCao_GetListDuyetBaoCaoByCriteria",
                    param: p,
