...
namespace SongAn.QLTS.Data.QLTS.DuyetBaoCao
{
    ...
    /// </summary>
    public class DuyetDuyetBaoCaoChiTietDac : BaseRepositoryAsync
    {
        ...
        public DuyetDuyetBaoCaoChiTietDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DuyetBaoCao_DuyetChiTiet",
                    param: p,
