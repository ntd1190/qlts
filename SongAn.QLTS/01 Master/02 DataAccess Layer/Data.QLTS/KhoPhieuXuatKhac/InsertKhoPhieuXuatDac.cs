...
{
    public class InsertKhoPhieuXuatDac : BaseRepositoryAsync
    {
        ...
        public InsertKhoPhieuXuatDac(ContextDto context) : base(context.dbQLTSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                        sql: "sp_KhoPhieuXuatKhac_InsertKhoPhieuXuat",
                        param: p,
