...
namespace SongAn.QLTS.Data.Main.CaiHinhFormCot
{
    public class GetListCauHinhFormCotByCriteriaDac : BaseRepositoryAsync
    {
        ...
        private void Init()
        {
            var fieldefault = nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.CauHinhFormCotId);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.MaForm);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.MaCot);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.TenCot);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.TenCotMacDinh);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.HienThiYN);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.ThuTu);
            fieldefault += "," + nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.CtrVersion);
            FieldsField = FieldsField.Equals("") ? fieldefault : FieldsField;

            OrderClause = OrderClause.Equals("") ? nameof(Entity.QLTS_MAIN.Entity.CauHinhFormCot.ThuTu) : OrderClause;
