...
{
    public class LapBaoCaoController : BaseController
    {
        ...
        [CustomAuthorize(FunctionCodes = "CN0038")]
        public ActionResult List()
        {
            string userLogin = LoadUserInfo("CN0038");
        ...
        {
            ViewBag.userInfo = LoadUserInfo("CN0038");
