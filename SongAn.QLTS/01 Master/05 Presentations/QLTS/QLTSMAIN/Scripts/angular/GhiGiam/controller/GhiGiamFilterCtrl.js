(function () {
    'use strict';
    angular.module('app').controller('GhiGiamFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'GhiGiamFilterCtrl';
        ...
        function initEventListener() {
            ...
            $scope.$on('GhiGiamFilterCtrl.action.SelectData', function (event, data) {
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('GhiGiamListCtrl.action.get-filter', data);
        }
