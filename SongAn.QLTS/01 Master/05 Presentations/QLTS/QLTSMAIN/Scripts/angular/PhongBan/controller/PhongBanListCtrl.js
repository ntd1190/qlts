(function () {
    ...
    function controller($rootScope, $scope, PhongBanService) {
        ...
        function eventAutoReload() {
            $scope.$on('sa.qltsmain.phongban.phongban.reload', function (event) {
                getPage(_tableState);
            });
        }
        ...
        function getPage(tableState) {
            ...
            PhongBanService.getPage(draw, start, number, searchString, sortName, sortDir, CoSoId, NhanVienId).then(function (success) {
