(function () {
    'use strict';
    angular.module('app').controller('DuyetCapFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'DuyetCapFilterCtrl';
        ...
        function initEventListener() {
            $scope.$on('DuyetCapFilterCtrl.action.SelectData', function (event, data) {
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('DuyetCapListCtrl.action.get-filter', data);
        }
