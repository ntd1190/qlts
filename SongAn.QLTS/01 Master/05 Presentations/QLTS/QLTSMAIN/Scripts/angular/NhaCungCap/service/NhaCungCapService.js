(function () {
    ...
    angular
        .module('app')
        .factory('NhaCungCapService', NhaCungCapService);

    function NhaCungCapService($http, API_BASE) {
    var api = {
        url: API_BASE+'Api.QLTS/NhaCungCap/',
        insert: 'InsertNhaCungCap',
        ...
        remove: 'DeleteNhaCungCap',
        removeList: 'DeleteListNhaCungCap',
    }
