(function () {
    'use strict';
    angular.module('app').controller('DuyetBaoCaoFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'DuyetBaoCaoFilterCtrl';
        ...
        vm.action.reset = function () {
            ...
            vm.data.endDate = moment().daysInMonth() + moment().format("/MM/YYYY");
            $rootScope.$broadcast('DuyetBaoCaoFilterCtrl.action.clearData');
        };

        /* BROADCAST / EMIT / ON FUNCTION */
        function initEventListener() {
            $scope.$on('DuyetBaoCaoFilterCtrl.action.SelectData', function (event, data) {
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('DuyetBaoCaoListCtrl.action.get-filter', data);
        }
