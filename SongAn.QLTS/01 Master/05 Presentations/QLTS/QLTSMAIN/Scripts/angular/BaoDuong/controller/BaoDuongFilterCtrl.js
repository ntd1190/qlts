(function () {
    'use strict';
    angular.module('app').controller('BaoDuongFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'BaoDuongFilterCtrl';
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('BaoDuongListCtrl.action.get-filter', data);
        }
