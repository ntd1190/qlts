(function () {
    'use strict';
    angular.module('app').controller('DenNghiTrangCapFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'DenNghiTrangCapFilterCtrl';
        ...
        function initEventListener() {
            $scope.$on('DenNghiTrangCapFilterCtrl.action.SelectData', function (event, data) {
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('DenNghiTrangCapListCtrl.action.get-filter', data);
        }
