...
app.controller('NhomTaiSanCombobox', function ($rootScope, $scope, NhomTaiSanService) {
    var vm = this;
    var userInfo;
    vm.controllerId = 'NhomTaiSanCombobox';
    vm.NameId = 'cbxNhomTaiSan';
    vm.data = {
        NhomTaiSanList: [],
    ...
    function OnClickSelect() {
        $scope.$emit(vm.controllerId + '.action.SelectData', vm.data.NhomTaiSan);
    }
    function getPage() {
        var CoSoId = userInfo.CoSoId;
        var NhanVienId = userInfo.NhanVienId;
        var Search = '';
        NhomTaiSanService.getCombobox(CoSoId, NhanVienId,Search).then(function (success) {
