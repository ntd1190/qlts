...
app.controller('NguonNganSachCombobox', function ($rootScope, $scope, NguonNganSachService) {
    var vm = this;
    var userInfo;
    vm.controllerId = 'NguonNganSachCombobox';
    vm.NameId = 'cbxNguonNganSach';
    vm.data = {
        NguonNganSachList: [],
    ...
    function eventAutoReload() {
        $scope.$on('sa.qltsmain.cbxNguonNganSach.cbxNguonNganSach.reload', function (event) {
            getPage();
        });
    }
    function OnClickSelect() {
        $scope.$emit(vm.controllerId + '.action.SelectData', vm.data.NguonNganSach);
    }
    function getPage() {
        var CoSoId = userInfo.CoSoId;
        var NhanVienId = userInfo.NhanVienId;
        var Search = '';
        NguonNganSachService.getCombobox(CoSoId, NhanVienId,Search).then(function (success) {
