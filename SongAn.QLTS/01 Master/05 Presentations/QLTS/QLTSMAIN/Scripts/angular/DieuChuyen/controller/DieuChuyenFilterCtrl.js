(function () {
    'use strict';
    angular.module('app').controller('DieuChuyenFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'DieuChuyenFilterCtrl';
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('DieuChuyenListCtrl.action.get-filter', data);
        }
