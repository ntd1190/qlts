(function () {
    'use strict';
    angular.module('app').controller('SuDungFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'SuDungFilterCtrl';
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('SuDungListCtrl.action.get-filter', data);
        }
