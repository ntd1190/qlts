(function () {
    'use strict';
    angular.module('app').controller('GhiTangFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'GhiTangFilterCtrl';
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('GhiTangListCtrl.action.get-filter', data);
        }
