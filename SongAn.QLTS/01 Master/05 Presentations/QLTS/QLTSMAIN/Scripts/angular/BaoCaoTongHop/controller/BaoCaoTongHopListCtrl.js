(function () {
    'use strict';
    angular.module('app').controller('BaoCaoTongHopListCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'BaoCaoTongHopListCtrl';
        ...
        vm.action.In = function () {
            ...
            if (bieuIn.toString() == "1") {
                ...
                $('#reportmodal').find('iframe').attr('src', '../../../QLTSMAIN/CrystalReport/ReportPage.aspx?name=rptTongHopSoTSCDBieuS21&data=' + data);
            }
        ...
        vm.action.XuatExcel = function () {
            ...
            if (bieuIn.toString() == "1") {
                ...
                $('#reportmodal').find('iframe').attr('src', '../../../QLTSMAIN/CrystalReport/ReportPage.aspx?name=rptTongHopSoTSCDBieuS21&export=1&data=' + data);
            }
        };
