(function () {
    'use strict';
    angular.module('app').controller('KhoPhieuXuatFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'KhoPhieuXuatFilterCtrl';
        ...
        vm.action.reset = function () {
            ...
            $rootScope.$broadcast('KhoPhieuXuatFilterCtrl.action.clearData');
        };

        /* BROADCAST / EMIT / ON FUNCTION */
        function initEventListener() {
            $scope.$on('KhoPhieuXuatFilterCtrl.action.SelectData', function (event, data) {
