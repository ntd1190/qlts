(function () {
    'use strict';
    angular.module('app').controller('KhaiThacFilterCtrl', function ($rootScope, $scope, utility) {
        /* PRIVATE */
        ...
        //end HOT-KEY
        /* VIEW MODEL */
        vm.controllerId = 'KhaiThacFilterCtrl';
        ...
        function emitSearch() {
            ...
            $rootScope.$broadcast('KhaiThacListCtrl.action.get-filter', data);
        }
