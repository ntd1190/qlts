...
namespace SongAn.QLTS.Biz.QLTS.KhoTaiSan
{
    ...
    /// </remarks>
    public class GetListKhoTaiSanByCriteriaBiz : SongAn.QLTS.Data.QLTS.KhoTaiSan.GetListKhoTaiSanSelectAllByCriteriaProjectionDac
    {
        ...
        public GetListKhoTaiSanByCriteriaBiz(ContextDto context) : base(context)
        {
