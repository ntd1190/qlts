...
namespace SongAn.QLTS.Biz.QLTS.LapBaoCao
{
    ...
    /// </remarks>
    public class DeleteLapBaoCaoByIdBiz : SongAn.QLTS.Data.QLTS.LapBaoCao.DeleteLapBaoCaoByIdDac
    {
        ...
        public DeleteLapBaoCaoByIdBiz(ContextDto context) : base(context)
        {
