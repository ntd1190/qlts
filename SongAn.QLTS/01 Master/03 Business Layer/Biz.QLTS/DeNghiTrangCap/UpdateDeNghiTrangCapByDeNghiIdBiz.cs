...
{
    public class UpdateDeNghiTrangCapByDeNghiIdBiz : UpdateDeNghiTrangCapByDeNghiIdDac
    {
        ...
        public UpdateDeNghiTrangCapByDeNghiIdBiz(ContextDto context) : base(context)
        {
