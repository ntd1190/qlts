...
using SongAn.QLTS.Data.QLNS.DeNghiTrangCap;

namespace SongAn.QLTS.Biz.QLTS.DeNghiTrangCap
{
    public class GetListDeNghiTrangCapChiTietByDeNghiIdBiz : GetListDeNghiTrangCapChiTietByDeNghiIdDac
    {
        ...
        public GetListDeNghiTrangCapChiTietByDeNghiIdBiz(ContextDto context) : base(context)
        {
