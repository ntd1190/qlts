...
{
    public class GetListTrangCapDeNghiByDeNghiIdBiz : GetListDeNghiTrangCapByDeNghiIdDac
    {
        ...
        public GetListTrangCapDeNghiByDeNghiIdBiz(ContextDto context) : base(context)
        {
