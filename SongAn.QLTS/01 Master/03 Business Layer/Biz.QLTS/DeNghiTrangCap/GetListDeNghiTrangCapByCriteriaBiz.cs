...
{
    public class GetListDeNghiTrangCapByCriteriaBiz : GetListDeNghiTrangCapByCriteriaDac
    {
        ...
        public GetListDeNghiTrangCapByCriteriaBiz(ContextDto context) : base(context)
        {
