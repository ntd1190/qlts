...
using SongAn.QLTS.Data.QLTS.KhachHang;

namespace SongAn.QLTS.Biz.QLTS.KhachHang
{
    public class GetListcbxKhachHangByIdBiz : GetListcbxKhachHangByIdDac
    {
        ...
        public GetListcbxKhachHangByIdBiz(ContextDto context) : base(context)
        {
