...
using SongAn.QLTS.Data.QLTS.NhanVien;

namespace SongAn.QLTS.Biz.QLTS.NhanVien
{
    public class UpdateNhanVienByIdBiz : UpdateNhanVienByIdDac
    {
        ...
        public UpdateNhanVienByIdBiz(ContextDto context) : base(context)
        {
