...
{
    public class GetListcbxHopDongByIdBiz : SongAn.QLTS.Data.QLTS.HopDong.GetListcbxHopDongByIdDac
    {
        ...
        public GetListcbxHopDongByIdBiz(ContextDto context) : base(context)
        {
