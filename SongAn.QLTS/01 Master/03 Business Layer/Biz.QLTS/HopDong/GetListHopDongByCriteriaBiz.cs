...
namespace SongAn.QLTS.Biz.QLTS.HopDong
{
    public class GetListHopDongByCriteriaBiz : SongAn.QLTS.Data.QLTS.HopDong.GetListHopDongByCriteriaDac
    {
        ...
        public GetListHopDongByCriteriaBiz(ContextDto context) : base(context)
        {
