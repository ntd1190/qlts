...
using SongAn.QLTS.Data.QLTS.TheoDoi;

namespace SongAn.QLTS.Biz.QLTS.TheoDoi
{
    public class GetListTheoDoiByCriteriaBiz: GetListTheoDoiByCriteriaDac
    {
        ...
        public GetListTheoDoiByCriteriaBiz(ContextDto context) : base(context)
        {
