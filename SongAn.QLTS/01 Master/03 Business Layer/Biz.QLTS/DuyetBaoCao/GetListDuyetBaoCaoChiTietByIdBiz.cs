...
using SongAn.QLTS.Data.QLTS.DuyetBaoCao;

namespace SongAn.QLTS.Biz.QLTS.DuyetBaoCao
{
    public class GetListDuyetBaoCaoChiTietByIdBiz : GetListDuyetBaoCaoChiTietByIdDac
    {
        ...
        public GetListDuyetBaoCaoChiTietByIdBiz(ContextDto context) : base(context)
        {
