...
namespace SongAn.QLTS.Biz.QLTS.NhaCungCap
{
    ...
    /// </remarks>
    public class GetListNhaCungCapByCriteriaBiz : SongAn.QLTS.Data.QLTS.NhaCungCap.GetListNhaCungCapSelectAllByCriteriaProjectionDac
    {
        ...
        public GetListNhaCungCapByCriteriaBiz(ContextDto context) : base(context)
        {
