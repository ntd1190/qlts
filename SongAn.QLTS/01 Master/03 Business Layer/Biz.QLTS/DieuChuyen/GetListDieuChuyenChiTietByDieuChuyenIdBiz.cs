...
using SongAn.QLTS.Data.QLNS.DieuChuyen;

namespace SongAn.QLTS.Biz.QLTS.DieuChuyen
{
    public class GetListDieuChuyenChiTietByDieuChuyenIdBiz : GetListDieuChuyenChiTietByDieuChuyenIdDac
    {
        ...
        public GetListDieuChuyenChiTietByDieuChuyenIdBiz(ContextDto context) : base(context)
        {
