...
{
    public class GetListDieuChuyenByDieuChuyenIdBiz : GetListDieuChuyenByDieuChuyenIdDac
    {
        ...
        public GetListDieuChuyenByDieuChuyenIdBiz(ContextDto context) : base(context)
        {
