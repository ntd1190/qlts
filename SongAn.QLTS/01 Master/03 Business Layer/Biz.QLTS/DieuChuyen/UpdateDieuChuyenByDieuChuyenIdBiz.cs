...
{
    public class UpdateDieuChuyenByDieuChuyenIdBiz : UpdateDieuChuyenByDieuChuyenIdDac
    {
        ...
        public UpdateDieuChuyenByDieuChuyenIdBiz(ContextDto context) : base(context)
        {
