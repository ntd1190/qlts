...
using SongAn.QLTS.Data.QLTS.DuyetMua;

namespace SongAn.QLTS.Biz.QLTS.DuyetMua
{
    public class DuyetDuyetMuaChiTietBiz : DuyetDuyetMuaChiTietDac
    {
        ...
        public DuyetDuyetMuaChiTietBiz(ContextDto context) : base(context)
        {
