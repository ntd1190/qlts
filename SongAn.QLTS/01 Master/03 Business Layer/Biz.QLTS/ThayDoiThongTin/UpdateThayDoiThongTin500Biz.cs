...
3. Function     : 
4. Description  : 
5. History      : 2017.09.13 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
...
namespace SongAn.QLTS.Biz.QLTS.ThayDoiThongTin
{
    ...
    /// </remarks>
    public class UpdateThayDoiThongTin500Biz : UpdateThayDoiThongTin500Dac
    {
        ...
        public UpdateThayDoiThongTin500Biz(ContextDto context) : base(context)
        {
