...
using SongAn.QLTS.Data.QLTS.ChotSoLieuNam;

namespace SongAn.QLTS.Biz.QLTS.ChotSoLieuNam
{
    public class ChotSoLieuNamBiz : ChotSoLieuNamDac
    {
        ...
        public ChotSoLieuNamBiz(ContextDto context) : base(context)
        {
