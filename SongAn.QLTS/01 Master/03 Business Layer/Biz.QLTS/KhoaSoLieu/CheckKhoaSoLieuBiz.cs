...
3. Function     : 
4. Description  : 
5. History      : 2017.10.16 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using SongAn.QLTS.Data.QLTS.KhoaSoLieu;
...
namespace SongAn.QLTS.Biz.QLTS.KhoaSoLieu
{
    ...
    /// </remarks>
    public class CheckKhoaSoLieuBiz : CheckKhoaSoLieuDac
    {
        ...
        public CheckKhoaSoLieuBiz(ContextDto context) : base(context)
        {
