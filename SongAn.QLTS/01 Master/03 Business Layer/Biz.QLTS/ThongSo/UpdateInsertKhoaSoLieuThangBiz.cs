...
{
    public class UpdateInsertKhoaSoLieuThangBiz : SongAn.QLTS.Data.QLTS.ThongSo.UpdateInsertKhoaSoLieuThangDac
    {
        ...
        public UpdateInsertKhoaSoLieuThangBiz(ContextDto context) : base(context)
        {
