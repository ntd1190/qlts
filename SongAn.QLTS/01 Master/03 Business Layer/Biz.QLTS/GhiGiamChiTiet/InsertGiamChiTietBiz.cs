...
using SongAn.QLTS.Data.QLTS.GhiGiamChiTiet;

namespace SongAn.QLTS.Biz.QLTS.GhiGiamChiTiet
{
    public class InsertGiamChiTietBiz : InsertGhiGiamChiTietDac
    {
        ...
        public InsertGiamChiTietBiz(ContextDto context) : base(context)
        {
