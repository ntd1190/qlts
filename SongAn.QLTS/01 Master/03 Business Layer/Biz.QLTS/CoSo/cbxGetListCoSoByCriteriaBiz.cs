...
*****************************************************************************/
using SongAn.QLTS.Data.QLTS.CoSo;
...
namespace SongAn.QLTS.Biz.QLTS.CoSo
{
    ...
    /// </remarks>
    public class cbxGetListCoSoByCriteriaBiz : cbxGetListCoSoByCriteriaDac
    {
        ...
        public cbxGetListCoSoByCriteriaBiz(ContextDto context) : base(context)
        {
