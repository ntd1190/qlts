...
namespace SongAn.QLTS.Biz.QLTS.CoSo
{
    ...
    /// </remarks>
    public class GetListCoSoByCriteriaBiz : SongAn.QLTS.Data.QLTS.CoSo.GetListCoSoSelectAllByCriteriaProjectionDac
    {
        ...
        public GetListCoSoByCriteriaBiz(ContextDto context) : base(context)
        {
