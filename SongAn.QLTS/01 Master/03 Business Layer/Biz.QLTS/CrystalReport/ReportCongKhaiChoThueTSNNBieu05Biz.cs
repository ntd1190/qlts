...
{
    public class ReportCongKhaiChoThueTSNNBieu05Biz : ReportCongKhaiChoThueTSNNBieu05Dac
    {
        ...
        public ReportCongKhaiChoThueTSNNBieu05Biz(ContextDto context) : base(context)
        {
