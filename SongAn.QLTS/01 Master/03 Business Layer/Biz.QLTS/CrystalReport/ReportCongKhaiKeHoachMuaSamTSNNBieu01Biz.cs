...
{
    public class ReportCongKhaiKeHoachMuaSamTSNNBieu01Biz : ReportCongKhaiKeHoachMuaSamTSNNBieu01Dac
    {
        ...
        public ReportCongKhaiKeHoachMuaSamTSNNBieu01Biz(ContextDto context) : base(context)
        {
