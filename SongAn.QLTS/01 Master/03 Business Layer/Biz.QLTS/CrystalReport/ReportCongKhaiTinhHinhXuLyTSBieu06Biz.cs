...
{
    public class ReportCongKhaiTinhHinhXuLyTSBieu06Biz : ReportCongKhaiTinhHinhXuLyTSBieu06Dac
    {
        ...
        public ReportCongKhaiTinhHinhXuLyTSBieu06Biz(ContextDto context) : base(context)
        {
