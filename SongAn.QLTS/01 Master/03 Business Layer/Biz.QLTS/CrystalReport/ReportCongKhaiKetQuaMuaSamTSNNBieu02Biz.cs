...
{
    public class ReportCongKhaiKetQuaMuaSamTSNNBieu02Biz : ReportCongKhaiKetQuaMuaSamTSNNBieu02Dac
    {
        ...
        public ReportCongKhaiKetQuaMuaSamTSNNBieu02Biz(ContextDto context) : base(context)
        {
