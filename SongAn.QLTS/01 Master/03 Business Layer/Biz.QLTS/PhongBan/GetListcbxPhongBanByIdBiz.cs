...
{
    public class GetListcbxPhongBanByIdBiz : SongAn.QLTS.Data.QLTS.PhongBan.GetListcbxPhongBanByIdDac
    {
        ...
        public GetListcbxPhongBanByIdBiz(ContextDto context) : base(context)
        {
