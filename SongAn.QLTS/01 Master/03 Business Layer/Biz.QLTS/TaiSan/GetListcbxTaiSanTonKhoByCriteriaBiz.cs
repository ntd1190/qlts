...
namespace SongAn.QLTS.Biz.QLTS.TaiSan
{
    ...
    /// </remarks>
    public class GetListcbxTaiSanTonKhoByCriteriaBiz : GetListcbxTaiSanTonKhoByCriteriaDac
    {
        ...
        public GetListcbxTaiSanTonKhoByCriteriaBiz(ContextDto context) : base(context)
        {
