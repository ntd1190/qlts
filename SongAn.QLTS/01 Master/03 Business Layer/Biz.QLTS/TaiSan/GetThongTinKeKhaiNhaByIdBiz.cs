...
3. Function     : 
4. Description  : 
5. History      : 2017.09.09 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
...
namespace SongAn.QLTS.Biz.QLTS.TaiSan
{
    ...
    /// </remarks>
    public class GetThongTinKeKhaiNhaByIdBiz : GetThongTinKeKhaiNhaByIdDac
    {
        ...
        public GetThongTinKeKhaiNhaByIdBiz(ContextDto context) : base(context)
        {
