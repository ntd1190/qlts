...
namespace SongAn.QLTS.Biz.QLTS.TaiSan
{
    ...
    /// </remarks>
    public class GetListcbxTaiSanSuDungByCriteriaBiz : GetListcbxTaiSanSuDungByCriteriaDac
    {
        ...
        public GetListcbxTaiSanSuDungByCriteriaBiz(ContextDto context) : base(context)
        {
