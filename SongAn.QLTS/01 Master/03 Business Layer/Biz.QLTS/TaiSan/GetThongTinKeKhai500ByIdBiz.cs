...
3. Function     : 
4. Description  : 
5. History      : 2017.09.08 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using SongAn.QLTS.Data.QLTS.TaiSan;
using SongAn.QLTS.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLTS.Biz.QLTS.TaiSan
{
    /// <summary>
    ...
    /// </remarks>
    public class GetThongTinKeKhai500ByIdBiz : GetThongTinKeKhai500ByIdDac
    {
        ...
        public GetThongTinKeKhai500ByIdBiz(ContextDto context) : base(context)
        {
