...
using SongAn.QLTS.Data.QLTS.KhaiThac;

namespace SongAn.QLTS.Biz.QLTS.KhaiThac
{
    public class GetListKhaiThacByCriteriaBiz : GetListKhaiThacByCriteriaDac
    {
        ...
        public GetListKhaiThacByCriteriaBiz(ContextDto context) : base(context)
        {
