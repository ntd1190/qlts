...
using SongAn.QLTS.Data.QLTS.ChotSoLieuThang;

namespace SongAn.QLTS.Biz.QLTS.ChotSoLieuThang
{
    public class ChotSoLieuThangBiz : ChotSoLieuThangDac
    {
        ...
        public ChotSoLieuThangBiz(ContextDto context) : base(context)
        {
