...
3. Function     : 
4. Description  : 
5. History      : 2017.09.06 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using SongAn.QLTS.Data.QLTS.HienTrangSuDung;
using SongAn.QLTS.Util.Common.Dto;
using System.Collections.Generic;
using System.Data;
using System.Threading.Tasks;

namespace SongAn.QLTS.Biz.QLTS.HienTrangSuDung
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListcbxHienTrangSuDungByCriteriaBiz : GetListcbxHienTrangSuDungByCriteriaDac
    {
        ...
        public GetListcbxHienTrangSuDungByCriteriaBiz(ContextDto context) : base(context)
        {
