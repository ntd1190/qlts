...
namespace SongAn.QLTS.Biz.QLTS.LoaiTaiSan
{
    ...
    /// </remarks>
    public class GetListLoaiTaiSanByCriteriaBiz : SongAn.QLTS.Data.QLTS.LoaiTaiSan.GetListLoaiTaiSanSelectAllByCriteriaProjectionDac
    {
        ...
        public GetListLoaiTaiSanByCriteriaBiz(ContextDto context) : base(context)
        {
