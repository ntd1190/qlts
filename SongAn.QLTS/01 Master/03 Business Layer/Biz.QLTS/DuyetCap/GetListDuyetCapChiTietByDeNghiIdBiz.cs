...
using SongAn.QLTS.Data.QLNS.DuyetCap;

namespace SongAn.QLTS.Biz.QLTS.DuyetCap
{
    public class GetListDuyetCapChiTietByDeNghiIdBiz : GetListDuyetCapChiTietByDeNghiIdDac
    {
        ...
        public GetListDuyetCapChiTietByDeNghiIdBiz(ContextDto context) : base(context)
        {
