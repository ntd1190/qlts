...
using SongAn.QLTS.Data.QLTS.BaoDuong;

namespace SongAn.QLTS.Biz.QLTS.BaoDuong
{
    public class GetListSuaChuaByBaoDuongIdBiz : GetListSuaChuaByBaoDuongIdDac
    {
        ...
        public GetListSuaChuaByBaoDuongIdBiz(ContextDto context) : base(context)
        {
