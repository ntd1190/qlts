...
using SongAn.QLTS.Data.QLNS.GhiTang;

namespace SongAn.QLTS.Biz.QLTS.GhiTang
{
    public class GetListGhiTangChiTietByGhiTangIdBiz : GetListGhiTangChiTietByGhiTangIdDac
    {
        ...
        public GetListGhiTangChiTietByGhiTangIdBiz(ContextDto context) : base(context)
        {
