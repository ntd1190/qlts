using SongAn.QLTS.Data.QLNS.NguoiDung;
...
namespace SongAn.QLTS.Biz.QLNS.NguoiDung
{
    public class GetListNguoiDungByCriteraBiz : GetListNguoiDungByProjectionDac
    {
        ...
        public GetListNguoiDungByCriteraBiz(ContextDto context) : base(context)
        {
