using SongAn.QLTS.Data.Main.VaiTro;
using SongAn.QLTS.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLTS.Biz.Main.VaiTro
{
    public class GetListVaiTroByCriteriaBiz : GetListVaiTroByCriteriaDac
    {
        ...
        public GetListVaiTroByCriteriaBiz(ContextDto context) : base(context)
        {
