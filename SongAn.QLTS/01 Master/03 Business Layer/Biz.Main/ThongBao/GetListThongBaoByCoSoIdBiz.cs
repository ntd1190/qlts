using SongAn.QLTS.Data.Main.ThongBao;
...
namespace SongAn.QLTS.Biz.Main.ThongBao
{
    public class GetListThongBaoByCoSoIdBiz : GetListThongBaoByCoSoIdDac
    {
        ...
        public GetListThongBaoByCoSoIdBiz(ContextDto context) : base(context)
        {
