using SongAn.QLDN.Data.QLNS.DuAn;
...
namespace SongAn.QLDN.Biz.QLNS.DuAn
{
    public class GetListDuAnByCriteraBiz : GetListDuAnByProjectionDac
    {
        ...
        public GetListDuAnByCriteraBiz(ContextDto context) : base(context)
        {
