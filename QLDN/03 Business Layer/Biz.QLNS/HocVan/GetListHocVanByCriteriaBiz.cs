using SongAn.QLDN.Data.QLNS.HocVan;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLNS.HocVan
{
    public class GetListHocVanByCriteriaBiz : GetListHocVanByCriteriaDac
    {
        ...
        public GetListHocVanByCriteriaBiz(ContextDto context) : base(context)
        {
