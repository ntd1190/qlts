using SongAn.QLDN.Data.QLNS.PhepNam;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLNS.PhepNam
{
    public class GetListPhepNamByNhanVienIdBiz : GetListPhepNamByNhanVienIdDac
    {
        ...
        public GetListPhepNamByNhanVienIdBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
