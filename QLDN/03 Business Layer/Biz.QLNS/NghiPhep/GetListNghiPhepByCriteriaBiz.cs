...
namespace SongAn.QLDN.Biz.QLNS.NghiPhep
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListNghiPhepByCriteriaBiz : SongAn.QLDN.Data.QLNS.NghiPhep.GetListNghiPhepByCriteriaDac
    {
        ...
        public GetListNghiPhepByCriteriaBiz(ContextDto context) : base(context)
        {
