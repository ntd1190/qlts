...
3. Function     : 
4. Description  : thêm mới hợp đồng của nhân viên
...
namespace SongAn.QLDN.Biz.QLNS.QuanLyHopDong
{
    ...
    /// </remarks>
    public class InsertQuanLyHopDongBiz : Entity.MSSQL_QLDN_QLNS.Entity.QuanLyHopDong
    {
        ...
        public InsertQuanLyHopDongBiz(ContextDto context)
        {
            _context = context;
        }
        #endregion
