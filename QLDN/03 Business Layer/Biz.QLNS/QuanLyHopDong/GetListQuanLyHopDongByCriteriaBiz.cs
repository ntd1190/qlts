...
3. Function     : 
4. Description  : lấy danh sách thông tin hợp đồng của nhân viên
5. History      : 2017.05.25(Nguyễn Thanh Bình) - Tao moi
*****************************************************************************/
using SongAn.QLDN.Data.QLNS.QuanLyHopDong;
...
namespace SongAn.QLDN.Biz.QLNS.QuanLyHopDong
{
    ...
    /// </remarks>
    public class GetListQuanLyHopDongByCriteriaBiz : GetListQuanLyHopDongByCriteriaDac
    {
