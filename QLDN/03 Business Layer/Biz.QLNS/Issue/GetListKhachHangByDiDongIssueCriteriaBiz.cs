...
namespace SongAn.QLDN.Biz.QLNS.Issue
{
    public class GetListKhachHangByDiDongIssueCriteriaBiz : Data.QLNS.Issue.GetListKhachHangByDiDongIssueDac
    {
        ...
        public GetListKhachHangByDiDongIssueCriteriaBiz(ContextDto context) : base(context)
        {
