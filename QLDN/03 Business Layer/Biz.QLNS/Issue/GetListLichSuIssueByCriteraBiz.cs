using SongAn.QLDN.Data.QLNS.Issue;
...
{
    public class GetListLichSuIssueByCriteraBiz : GetListLichSuIssueByProjectionDac
    {
        ...
        public GetListLichSuIssueByCriteraBiz(ContextDto context) : base(context)
        {
