...
3. Function     : QLDNMAIN/chucvu/insert
4. Description  : Goi dac insert chuc vu
...
namespace SongAn.QLDN.Biz.QLNS.ChucVu
{
    /// <summary>
    ...
    /// </remarks>
    public class InsertChucVuBiz : SongAn.QLDN.Data.QLNS.ChucVu.InsertChucVuDac
    {
        ...
        public InsertChucVuBiz(ContextDto context) : base(context)
        {
