...
4. Description  : Goi dac thong tin chuc vu
...
namespace SongAn.QLDN.Biz.QLNS.ChucVu
{
    ...
    /// </remarks>
    public class GetChucVuByIdBiz : SongAn.QLDN.Data.QLNS.ChucVu.GetChucVuByIdDac
    {
        ...
        public GetChucVuByIdBiz(ContextDto context) : base(context)
        {
