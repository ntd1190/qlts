...
namespace SongAn.QLDN.Biz.QLNS.ChamCong
{
    public class GetListChamCongByCriteraBiz : GetListChamCongByProjectionDac
    {
        ...
        public GetListChamCongByCriteraBiz(ContextDto context) : base(context)
        {
