...
4. Description  : lấy danh sách quá trình cong tác của nhân viên
...
namespace SongAn.QLDN.Biz.QLNS.QuaTrinhCongTac
{
    ...
    /// </remarks>
    public class GetListQuaTrinhCongTacByCriteriaBiz : GetListQuaTrinhCongTacByCriteriaDac
    {
        ...
        public GetListQuaTrinhCongTacByCriteriaBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
