...
3. Function     : 
4. Description  : quá trình công tác của nhân viên
...
namespace SongAn.QLDN.Biz.QLNS.QuaTrinhCongTac
{
    ...
    /// </remarks>
    public class GetListQuaTrinhCongTacByNhanVienIdBiz : GetListQuaTrinhCongTacByCriteriaDac
    {
        ...
        public GetListQuaTrinhCongTacByNhanVienIdBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
