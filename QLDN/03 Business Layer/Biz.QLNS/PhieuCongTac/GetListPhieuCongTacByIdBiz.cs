...
namespace SongAn.QLDN.Biz.QLNS.PhieuCongTac
{
    ...
    /// </remarks>
    public class GetListPhieuCongTacByIdBiz : SongAn.QLDN.Data.QLNS.PhieuCongTac.GetListPhieuCongTacByIdDac
    {
        ...
        public GetListPhieuCongTacByIdBiz(ContextDto context) : base(context)
        {
