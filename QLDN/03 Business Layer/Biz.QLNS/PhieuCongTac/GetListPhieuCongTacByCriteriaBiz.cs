...
namespace SongAn.QLDN.Biz.QLNS.PhieuCongTac
{
    ...
    /// </remarks>
    public class GetListPhieuCongTacByCriteriaBiz : SongAn.QLDN.Data.QLNS.PhieuCongTac.GetListPhieuCongTacByCriteriaDac
    {
        ...
        public override async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            {
                // Modify ThanhToan
                var itemThanhToan = item.ThanhToan;
                if (itemThanhToan == null)
                {
                    item.ThanhToan = "0";
                }
            }
