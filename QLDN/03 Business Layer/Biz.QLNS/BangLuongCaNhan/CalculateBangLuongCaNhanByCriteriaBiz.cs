...
4. Description  : Biz Tính toán Bảng lương theo điều kiện
...
namespace SongAn.QLDN.Biz.QLNS.BangLuongCaNhan
{
    /// <summary>
    /// Biz Tính toán Bảng lương theo điều kiện
    /// </summary>
    /// <remarks>
    /// Luu y: 
    ...
    /// </remarks>
    public class CalculateBangLuongCaNhanByCriteriaBiz : SongAn.QLDN.Data.QLNS.BangLuongCaNhan.CalculateBangLuongCaNhanByCriteriaDac
    {
        ...
        public CalculateBangLuongCaNhanByCriteriaBiz(ContextDto context) : base(context)
        {
