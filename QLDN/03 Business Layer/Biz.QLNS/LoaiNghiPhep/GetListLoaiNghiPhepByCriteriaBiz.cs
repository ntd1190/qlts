...
4. Description  : Goi dac de lay danh sach Loai Nghi Phep voi dieu kien
5. History      : 
*****************************************************************************/
...
namespace SongAn.QLDN.Biz.QLNS.LoaiNghiPhep
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListLoaiNghiPhepByCriteriaBiz : SongAn.QLDN.Data.QLNS.LoaiNghiPhep.GetListLoaiNghiPhepByCriteriaDac
    {
        ...
        public GetListLoaiNghiPhepByCriteriaBiz(ContextDto context) : base(context)
        {
