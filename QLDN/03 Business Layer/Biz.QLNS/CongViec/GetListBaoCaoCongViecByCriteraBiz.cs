...
namespace SongAn.QLDN.Biz.QLNS.CongViec
{
    public class GetListBaoCaoCongViecByCriteraBiz : GetListBaoCaoCongViecByProjectionDac
    {
        ...
        public GetListBaoCaoCongViecByCriteraBiz(ContextDto context) : base(context)
        {
