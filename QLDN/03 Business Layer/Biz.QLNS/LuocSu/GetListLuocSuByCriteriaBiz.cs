using SongAn.QLDN.Data.QLNS.LuocSu;
...
namespace SongAn.QLDN.Biz.QLNS.LuocSu
{
    public class GetListLuocSuByCriteriaBiz : sp_LuocSu_GetListLuocSuByCriteriaDac
    {
        ...
        public GetListLuocSuByCriteriaBiz(ContextDto context) : base(context)
            {
