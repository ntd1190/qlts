...
{
        public class GetListTinhByCriteriaBiz : SongAn.QLDN.Data.QLNS.Tinh.GetListTinhSelectAllByCriteriaProjectionDac
        {
            ...
            public GetListTinhByCriteriaBiz(ContextDto context) : base(context)
            {
