using SongAn.QLDN.Data.QLNS.KyLuat;
...
namespace SongAn.QLDN.Biz.QLNS.KyLuat
{
    public class GetListKyLuatByCriterialBiz :GetListKyLuatByProjectionDac
    {
        ...
        public GetListKyLuatByCriterialBiz(ContextDto context) : base(context)
            {
