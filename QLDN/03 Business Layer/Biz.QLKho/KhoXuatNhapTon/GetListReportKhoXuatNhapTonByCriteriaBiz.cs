...
5. History      : 
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.KhoXuatNhapTon;
...
namespace SongAn.QLDN.Biz.QLKho.KhoXuatNhapTon
{
    public class GetListReportKhoXuatNhapTonByCriteriaBiz : GetListReportKhoXuatNhapTonByCriteriaDac
    {
        ...
        public GetListReportKhoXuatNhapTonByCriteriaBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
