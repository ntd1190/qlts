...
{
    public class GetListKhoXuatNhapTonByCriteriaBiz : GetListKhoXuatNhapTonByCriteriaDac
    {
        ...
        public GetListKhoXuatNhapTonByCriteriaBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
