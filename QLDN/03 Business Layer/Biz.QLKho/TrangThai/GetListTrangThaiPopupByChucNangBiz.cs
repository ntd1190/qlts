...
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.TrangThai;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLKho.TrangThai
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListTrangThaiPopupByChucNangBiz : GetListTrangThaiPopupByChucNangDac
    {
        ...
        public GetListTrangThaiPopupByChucNangBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
