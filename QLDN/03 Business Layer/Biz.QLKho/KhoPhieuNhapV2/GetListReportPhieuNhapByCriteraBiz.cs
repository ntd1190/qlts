...
{
    public class GetListReportPhieuNhapByCriteraBiz : GetListReportPhieuNhapByProjectionDac
    {
        ...
        public GetListReportPhieuNhapByCriteraBiz(ContextDto context) : base(context)
        {
