...
namespace SongAn.QLDN.Biz.QLNS.KhoPhieuBaoHanhThongKe
{
    public class GetListPhieuBaoHanhThongKeByProjectionBiz : GetListPhieuBaoHanhThongKeByProjectionDac
    {
        ...
        public GetListPhieuBaoHanhThongKeByProjectionBiz(ContextDto context) : base(context)
        {
