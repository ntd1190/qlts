...
3. Function     : 
4. Description  : LẤY DANH SÁCH PHIẾU CHUYỂN
5. History      : 2017.06.13 (NGUYỄN NGỌC TÂN) - Tao moi
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.KhoDuyetPhieu;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLKho.KhoDuyetPhieu
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListKhoDuyetPhieuByCriteriaBiz: GetListKhoDuyetPhieuByCriteriaDac
    {
