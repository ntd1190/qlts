...
3. Function     : 
4. Description  : LẤY DANH SÁCH PHIẾU XUẤT
...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuXuat
{
    /// <summary>
    ...
    /// </remarks>
    public class DeleteListChiTietByPhieuXuatIdBiz : DeleteListChiTietByPhieuXuatIdDac
    {
        ...
        public DeleteListChiTietByPhieuXuatIdBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
