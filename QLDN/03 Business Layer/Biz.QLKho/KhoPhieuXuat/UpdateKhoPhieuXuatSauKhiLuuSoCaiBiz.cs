...
{
    public class UpdateKhoPhieuXuatSauKhiLuuSoCaiBiz : UpdateKhoPhieuXuatSauKhiLuuSoCaiDac
    {
        ...
        public UpdateKhoPhieuXuatSauKhiLuuSoCaiBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
