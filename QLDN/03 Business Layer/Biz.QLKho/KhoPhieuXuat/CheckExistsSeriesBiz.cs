...
{
    /// <summary>
    /// Biz Lấy danh sách series theo điều kiện
    /// </summary>
    /// <remarks>
    /// Luu y: 
    ...
    /// </remarks>
    public class CheckExistsSeriesBiz : CheckExistsSeriesDac
    {
        ...
        public CheckExistsSeriesBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
