...
3. Function     : 
4. Description  : UPDATE XÓA PHIẾU XUẤT
...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuXuat
{
    ...
    /// </remarks>
    public class UpdateXoaListKhoPhieuXuatBiz : UpdateXoaListKhoPhieuXuatDac
    {
        ...
        public UpdateXoaListKhoPhieuXuatBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
