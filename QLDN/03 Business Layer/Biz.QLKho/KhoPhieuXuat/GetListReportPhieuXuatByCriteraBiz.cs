...
{
    public class GetListReportPhieuXuatByCriteraBiz : GetListReportPhieuXuatByProjectionDac
    {
        ...
        public GetListReportPhieuXuatByCriteraBiz(ContextDto context) : base(context)
        {
