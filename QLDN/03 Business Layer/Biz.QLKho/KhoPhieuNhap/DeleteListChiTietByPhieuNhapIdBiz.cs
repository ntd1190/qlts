...
3. Function     : 
4. Description  : LẤY DANH SÁCH PHIẾU NHẬP
...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuNhap
{
    ...
    /// </remarks>
    public class DeleteListChiTietByPhieuNhapIdBiz : DeleteListChiTietByPhieuNhapIdDac
    {
        ...
        public DeleteListChiTietByPhieuNhapIdBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
