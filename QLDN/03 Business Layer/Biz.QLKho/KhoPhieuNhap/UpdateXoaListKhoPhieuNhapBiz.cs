...
3. Function     : 
4. Description  : UPDATE XÓA PHIẾU NHẬP
5. History      : 2017.06.15 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuNhap
{
    ...
    /// </remarks>
    public class UpdateXoaListKhoPhieuNhapBiz : UpdateXoaListKhoPhieuNhapDac
    {
        ...
        public UpdateXoaListKhoPhieuNhapBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
