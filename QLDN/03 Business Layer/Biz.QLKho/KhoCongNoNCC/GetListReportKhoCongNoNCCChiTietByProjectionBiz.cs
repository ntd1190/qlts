...
{
    public class GetListReportKhoCongNoNCCChiTietByProjectionBiz : GetListReportKhoCongNoNCCChiTietByProjectionDac
    {
        ...
        public GetListReportKhoCongNoNCCChiTietByProjectionBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
