...
namespace SongAn.QLDN.Biz.QLKho.KhoCongNoNCC
{
    ...
    public class GetListKhoCongNoNCCChiTietByCriteriaBiz : SongAn.QLDN.Data.QLKho.KhoCongNoNCC.GetListKhoCongNoNCCChiTietByProjectionDac
    {
        ...
        public GetListKhoCongNoNCCChiTietByCriteriaBiz(ContextDto context) : base(context)
        {
