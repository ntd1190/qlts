...
namespace SongAn.QLDN.Biz.QLKho.KhoCongNoNCC
{
    ...
    public class GetListKhoCongNoNCCByCriteriaBiz : SongAn.QLDN.Data.QLKho.KhoCongNoNCC.GetListKhoCongNoNCCByProjectionDac
    {
        ...
        public GetListKhoCongNoNCCByCriteriaBiz(ContextDto context) : base(context)
        {
