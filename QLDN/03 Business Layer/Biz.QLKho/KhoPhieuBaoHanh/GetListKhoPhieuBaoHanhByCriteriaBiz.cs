...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </remarks>
    public class GetListKhoPhieuBaoHanhByCriteriaBiz : GetListKhoPhieuBaoHanhByCriteriaDac
    {
        ...
        public GetListKhoPhieuBaoHanhByCriteriaBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
