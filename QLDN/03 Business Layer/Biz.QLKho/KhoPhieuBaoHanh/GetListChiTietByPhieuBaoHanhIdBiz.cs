...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </remarks>
    public class GetListChiTietByPhieuBaoHanhIdBiz : GetListChiTietByPhieuBaoHanhIdDac
    {
        ...
        public GetListChiTietByPhieuBaoHanhIdBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
