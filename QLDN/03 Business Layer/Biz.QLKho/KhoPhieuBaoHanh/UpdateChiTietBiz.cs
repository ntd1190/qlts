...
5. History      : 2017.08.01 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.KhoPhieuBaoHanh;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLKho.KhoPhieuBaoHanh
{
    /// <summary>
    ...
    /// </remarks>
    public class UpdateChiTietBiz : UpdateChiTietDac
    {
        ...
        public UpdateChiTietBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
