...
namespace SongAn.QLDN.Biz.QLKho.KhoKhoHang
{
    /// <summary>
    ...
    /// </remarks>
    public class GetListKhoKhoHangPopupByCriteriaBiz : GetListKhoKhoHangPopupByCriteriaDac
    {
        ...
        public GetListKhoKhoHangPopupByCriteriaBiz(ContextDto context) : base(context)
        {
