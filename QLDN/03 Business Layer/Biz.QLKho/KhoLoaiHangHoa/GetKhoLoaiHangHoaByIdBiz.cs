...
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.KhoLoaiHangHoa;
...
namespace SongAn.QLDN.Biz.QLKho.KhoLoaiHangHoa
{
    ...
    /// </remarks>
    public class GetKhoLoaiHangHoaByIdBiz : GetKhoLoaiHangHoaByIdDac
    {
        ...
        public GetKhoLoaiHangHoaByIdBiz(ContextDto context) : base(context)
        {
