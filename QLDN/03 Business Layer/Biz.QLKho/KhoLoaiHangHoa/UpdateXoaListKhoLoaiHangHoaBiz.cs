...
namespace SongAn.QLDN.Biz.QLKho.KhoLoaiHangHoa
{
    ...
    /// </remarks>
    public class UpdateXoaListKhoLoaiHangHoaBiz : SongAn.QLDN.Data.QLKho.KhoLoaiHangHoa.UpdateXoaListKhoLoaiHangHoaDac
    {
        ...
        public UpdateXoaListKhoLoaiHangHoaBiz(ContextDto context) : base(context)
        {
