...
{
    public class GetListTonKhoChiTietByTonKhoIdBiz : GetListKhoTonKhoChiTietByTonKhoIdDac
    {
        ...
        public GetListTonKhoChiTietByTonKhoIdBiz(ContextDto context) : base(context)
        {
