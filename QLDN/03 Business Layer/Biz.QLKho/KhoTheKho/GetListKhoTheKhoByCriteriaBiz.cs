...
namespace SongAn.QLDN.Biz.QLKho.KhoTheKho
{


    public class GetListKhoTheKhoByCriteriaBiz : SongAn.QLDN.Data.QLKho.KhoTheKho.GetListKhoTheKhoByProjectionDac
    {
        ...
        public GetListKhoTheKhoByCriteriaBiz(ContextDto context) : base(context)
        {
