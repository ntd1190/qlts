...
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.KhoHangHoa;
...
namespace SongAn.QLDN.Biz.QLKho.KhoHangHoa
{
    ...
    /// </remarks>
    public class UpdateXoaListKhoHangHoaV2Biz : UpdateXoaListKhoHangHoaV2Dac
    {
        ...
        public UpdateXoaListKhoHangHoaV2Biz(ContextDto context) : base(context) { }
        #endregion
