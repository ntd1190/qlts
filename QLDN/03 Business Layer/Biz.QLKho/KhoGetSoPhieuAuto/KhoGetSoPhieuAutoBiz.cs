using SongAn.QLDN.Data.QLKho.KhoGetSoPhieuAuto;
...
namespace SongAn.QLDN.Biz.QLKho.KhoGetSoPhieuAuto
{
    public class KhoGetSoPhieuAutoBiz: KhoGetSoPhieuAutoDac
    {
        ...
        public KhoGetSoPhieuAutoBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
