...
4. Description  : THÊM THÔNG TIN HÃNG SẢN XUẤT
5. History      : 2017.06.07 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using SongAn.QLDN.Data.QLKho.KhoHangSanXuat;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Data;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLKho.KhoHangSanXuat
{
    /// <summary>
    ...
    /// </remarks>
    public class InsertKhoHangSanXuatBiz : InsertKhoHangSanXuatDac
    {
        ...
        public InsertKhoHangSanXuatBiz(ContextDto context) : base(context) { }
        #endregion
