...
namespace SongAn.QLDN.Biz.QLKho.KhoHangSanXuat
{
    ...
    /// </remarks>
    public class GetListKhoHangSanXuatByCriteriaBiz : GetListKhoHangSanXuatByCriteriaDac
    {
        ...
        public GetListKhoHangSanXuatByCriteriaBiz(ContextDto context) : base(context)
        {
