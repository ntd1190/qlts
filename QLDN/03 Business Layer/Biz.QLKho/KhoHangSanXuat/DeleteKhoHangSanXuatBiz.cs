...
4. Description  : XÓA THÔNG ITN HÃNG SẢN XUẤT
...
namespace SongAn.QLDN.Biz.QLKho.KhoHangSanXuat
{
    ...
    /// </remarks>
    public class DeleteKhoHangSanXuatBiz : DeleteKhoHangSanXuatDac
    {
        ...
        public DeleteKhoHangSanXuatBiz(ContextDto context) : base(context) { }
        #endregion
