using SongAn.QLDN.Data.QLKho.KhoImportDauKy;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLKho.KhoImportDauKy
{
    public class ImportDauKyBiz : ImportDauKyDac
    {
        ...
        public ImportDauKyBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
