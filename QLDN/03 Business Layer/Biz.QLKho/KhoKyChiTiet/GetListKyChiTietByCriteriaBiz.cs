...
namespace SongAn.QLDN.Biz.QLKho.KhoKyChiTiet
{
    public class GetListKyChiTietByCriteriaBiz : GetListTheKhoXuatNhapTonByCriteriaDac
    {
        ...
        public GetListKyChiTietByCriteriaBiz(ContextDto context) : base(context)
        {
            _context = context;
        }
        #endregion
