using SongAn.QLDN.Data.QLKho.KhoImportExcelDauKy;
using SongAn.QLDN.Util.Common.Dto;
using System.Collections.Generic;
using System.Threading.Tasks;

namespace SongAn.QLDN.Biz.QLKho.KhoImportExcelDauKy
{
    public class ImportExcelDauKyBiz : ImportExcelDauKyDac
    {
        ...
        public ImportExcelDauKyBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
