...
namespace SongAn.QLDN.Biz.QLKho.KhoNuocSanXuat
{
    ...
    /// </remarks>
    public class GetListKhoNuocSanXuatByCriteriaBiz : SongAn.QLDN.Data.QLKho.KhoNuocSanXuat.GetListKhoNuocSanXuatCriteriaProjectionDac
    {
        ...
        public GetListKhoNuocSanXuatByCriteriaBiz(ContextDto context) : base(context)
        {
