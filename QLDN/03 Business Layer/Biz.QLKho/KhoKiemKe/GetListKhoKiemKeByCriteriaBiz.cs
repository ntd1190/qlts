...
{
    public class GetListKhoKiemKeByCriteriaBiz : SongAn.QLDN.Data.QLKho.KhoKiemKe.GetListKhoKiemKeByProjectionDac
    {
        ...
        public GetListKhoKiemKeByCriteriaBiz(ContextDto context) : base(context)
        {
