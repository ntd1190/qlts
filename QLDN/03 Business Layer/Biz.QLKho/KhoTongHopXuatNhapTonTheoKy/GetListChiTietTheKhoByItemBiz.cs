using SongAn.QLDN.Data.QLKho.KhoTongHopXuatNhapTonTheoKy;
...
{
    public class GetListChiTietTheKhoByItemBiz : GetListChiTietTheKhoByItemDac
    {
        ...
        public GetListChiTietTheKhoByItemBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
