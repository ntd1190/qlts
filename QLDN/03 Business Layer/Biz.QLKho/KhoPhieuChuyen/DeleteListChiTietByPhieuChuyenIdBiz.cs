...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuChuyen
{
    ...
    /// </remarks>
    public class DeleteListChiTietByPhieuChuyenIdBiz : DeleteListChiTietByPhieuChuyenIdDac
    {
        ...
        public DeleteListChiTietByPhieuChuyenIdBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
