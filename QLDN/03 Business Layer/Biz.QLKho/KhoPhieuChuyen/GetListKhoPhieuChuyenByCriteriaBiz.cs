...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuChuyen
{
    ...
    /// </remarks>
    public class GetListKhoPhieuChuyenByCriteriaBiz: GetListKhoPhieuChuyenByCriteriaDac
    {
        ...
        public GetListKhoPhieuChuyenByCriteriaBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
