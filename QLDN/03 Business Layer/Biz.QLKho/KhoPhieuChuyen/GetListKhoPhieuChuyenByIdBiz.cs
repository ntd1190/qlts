...
3. Function     : 
4. Description  : LẤY THÔNG TIN PHIẾU CHUYỂN
...
namespace SongAn.QLDN.Biz.QLKho.KhoPhieuChuyen
{
    ...
    /// </remarks>
    public class GetListKhoPhieuChuyenByIdBiz: GetListKhoPhieuChuyenByIdDac
    {
        ...
        public GetListKhoPhieuChuyenByIdBiz(ContextDto context):base(context)  {
            _context = context;
        }
        #endregion
