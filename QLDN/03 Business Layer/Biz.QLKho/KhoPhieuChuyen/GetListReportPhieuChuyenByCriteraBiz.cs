...
{
    public class GetListReportPhieuChuyenByCriteraBiz : GetListReportPhieuChuyenByProjectionDac
    {
        ...
        public GetListReportPhieuChuyenByCriteraBiz(ContextDto context) : base(context)
        {
