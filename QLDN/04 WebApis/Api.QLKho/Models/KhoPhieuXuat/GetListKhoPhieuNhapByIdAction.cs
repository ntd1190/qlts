...
{
    public class GetListKhoPhieuXuatByIdAction
    {

        #region PUBLIC
        public string phieuXuatIds { get; set; }
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                var biz = new GetListKhoPhieuXuatByIdBiz(context);
                biz.PHIEU_XUAT_IDS = phieuXuatIds;
