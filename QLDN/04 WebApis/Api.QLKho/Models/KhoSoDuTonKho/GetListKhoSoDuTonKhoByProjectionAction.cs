...
using SongAn.QLDN.Biz.QLKho.KhoSoDuTonKho;
using System.Linq;
using System.Globalization;

namespace SongAn.QLDN.Api.QLKho.Models.KhoSoDuTonKho
{
    public class GetListKhoSoDuTonKhoByProjectionAction
    {
        ...
        {
            GetListKhoSoDuTonKhoByCriteriaBiz biz = new GetListKhoSoDuTonKhoByCriteriaBiz(context);
