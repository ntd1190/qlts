...
using SongAn.QLDN.Biz.QLKho.KhoCongNoKhachHang;
using System.Linq;
using System.Globalization;

namespace SongAn.QLDN.Api.QLKho.Models.KhoCongNoKhachHang
{
    public class GetListKhoCongNoKhachHangChiTietByProjectionAction
    {
        ...
        {
            GetListKhoCongNoKhachHangChiTietByCriteriaBiz biz = new GetListKhoCongNoKhachHangChiTietByCriteriaBiz(context);
