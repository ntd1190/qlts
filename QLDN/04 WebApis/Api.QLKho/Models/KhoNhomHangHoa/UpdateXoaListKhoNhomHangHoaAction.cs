...
3. Function     : QLDNKHO/KHONHOMHANGHOA/LIST
4. Description  : UPDATE XÓA
...
{
    public class UpdateXoaListKhoNhomHangHoaAction
    {
        #region public
        /// <summary>
        /// array json stirng
        /// </summary>
        public string listNhomHangHoa { get; set; }
        public string LoginId { get; set; }
        #endregion

        #region private
        private List<Entity.MSSQL_QLDN_QLNS.Entity.KhoNhomHangHoa> _list;
        ...
        private void init()
        {
            _list = JsonConvert.DeserializeObject<List<Entity.MSSQL_QLDN_QLNS.Entity.KhoNhomHangHoa>>(listNhomHangHoa);
