...
using SongAn.QLDN.Biz.QLKho.KhoKiemKe;
using System.Linq;
using System.Globalization;

namespace SongAn.QLDN.Api.QLKho.Models.KhoKiemKe
{
    public class GetListKhoKiemKeByProjectionAction
    {
        ...
        {
            GetListKhoKiemKeByCriteriaBiz biz = new GetListKhoKiemKeByCriteriaBiz(context);
