...
namespace SongAn.QLDN.Api.QLKho.Models.KhoPhieuBaoHanh
{
    public class InsertChiTietAction
    {
        ...
        #region PUBLIC
        public virtual string PhieuBaoHanhId { get; set; }
        ...
        private void init()
        {
            ...
            _ThueVAT = Protector.Decimal(ThueVAT, 0);
        ...
        {
            if (_PhieuBaoHanhId == 0)
            {
                throw new BaseException("Không tìm thấy thông tin phiếu bảo hành");
            }
        }
