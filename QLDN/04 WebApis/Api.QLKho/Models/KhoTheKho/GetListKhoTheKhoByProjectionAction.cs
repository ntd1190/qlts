...
using SongAn.QLDN.Biz.QLKho.KhoTheKho;
using System.Linq;
using System.Globalization;

namespace SongAn.QLDN.Api.QLKho.Models.KhoTheKho
{
    public class GetListKhoTheKhoByProjectionAction
    {
        ...
        {
            GetListKhoTheKhoByCriteriaBiz biz = new GetListKhoTheKhoByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "TheKhoId" : sortName;
                ...
                IEnumerable<dynamic> listTheKho = await biz.Execute();
                if (listTheKho.Count() > 0)
                {
                    var obj = listTheKho.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listTheKho, _metaData);
            }
            catch (Exception ex)
            {
