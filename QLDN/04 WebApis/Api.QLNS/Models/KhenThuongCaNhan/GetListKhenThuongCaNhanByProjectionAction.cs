using SongAn.QLDN.Biz.QLNS.KhenThuongCaNhan;
...
{
    public class GetListKhenThuongCaNhanByProjectionAction
    {
        ...
        {
            GetListKhenThuongCaNhanByCriteriaBiz biz = new GetListKhenThuongCaNhanByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "KhenThuongCaNhanId" : sortName;
