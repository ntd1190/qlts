using SongAn.QLDN.Biz.QLNS.KhenThuong;
...
{
    public class GetListKhenThuongByProjectionAction
    {
        ...
        {
            GetListKhenThuongByCriteriaBiz biz = new GetListKhenThuongByCriteriaBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "KhenThuongId" : sortName;
                ...
                if (search != null && search != "")
                {
                    ...
                    if (search.Split('|')[2] != "") biz.HinhThuc = search.Split('|')[2].Substring(0, search.Split('|')[2].Length - 1);
