...
{
    public class GetListCongViecTruocDayByCriteriaAction
    {
        #region PUBLIC
      ...
      private int _start;
        ...
        private void init()
        {
            ...
            sortName = Protector.String(sortName, "CVTD_ID");
        ...
        public async Task<ActionResultDto> Execute(ContextDto context)
        {
            try
            {
                ...
                var biz = new GetListCongViecTruocDayByCriteriaBiz(context);
