...
{
    public class GetListCongViecByProjectionAction
    {
        ...
        {
            GetListCongViecByCriteraBiz biz = new GetListCongViecByCriteraBiz(context);
            ...
            try
            {
                 ...
                 * fixed input
                 * ========================= */
                sortName = string.IsNullOrEmpty(sortName) ? "CongViecId" : sortName;
                ...
                biz.Skip = _start;
                biz.Take = _length;
                IEnumerable<dynamic> listCongViec = await biz.Execute();
                if (listCongViec.Count() > 0)
                {
                    var obj = listCongViec.FirstOrDefault();
                ...
                return ActionHelper.returnActionResult(HttpStatusCode.OK, listCongViec, _metaData);
            }
            catch (Exception ex)
            {
