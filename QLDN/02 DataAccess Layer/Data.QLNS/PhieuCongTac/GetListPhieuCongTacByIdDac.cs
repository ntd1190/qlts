...
namespace SongAn.QLDN.Data.QLNS.PhieuCongTac
{
    ...
    /// </summary>
    public class GetListPhieuCongTacByIdDac : BaseRepositoryAsync
    {
        ...
        public GetListPhieuCongTacByIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_PhieuCongTac_GetListPhieuCongTacById",
                    param: this,
