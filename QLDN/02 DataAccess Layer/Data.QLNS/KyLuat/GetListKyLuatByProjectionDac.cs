...
namespace SongAn.QLDN.Data.QLNS.KyLuat
{
    public class GetListKyLuatByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKyLuatByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KyLuat_GetListKyLuatByCriteria",
                    param: p,
