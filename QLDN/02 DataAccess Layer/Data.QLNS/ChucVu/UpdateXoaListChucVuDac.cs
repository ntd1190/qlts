...
namespace SongAn.QLDN.Data.QLNS.ChucVu
{
    ...
    /// </summary>
    public class UpdateXoaListChucVuDac : BaseRepositoryAsync
    {
        ...
        public UpdateXoaListChucVuDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ChucVu_UpdateXoaListChucVu",
                    param: this,
