...
namespace SongAn.QLDN.Data.QLNS.LuocSu
{
    public class sp_LuocSu_GetListLuocSuByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public sp_LuocSu_GetListLuocSuByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_LuocSu_GetListLuocSuByCriteria",
                    param: p,
