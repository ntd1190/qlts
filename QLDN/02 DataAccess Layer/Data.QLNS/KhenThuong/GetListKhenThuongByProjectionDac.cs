...
namespace SongAn.QLDN.Data.QLNS.KhenThuong
{
    public class GetListKhenThuongByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhenThuongByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhenThuong_GetListKhenThuongByCriteria",
                    param: p,
