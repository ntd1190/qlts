...
namespace SongAn.QLDN.Data.QLNS.Tinh
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListTinhSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListTinhSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_TinhThanhPho_SelectAllByCriteriaProjection",
                    param: p,
