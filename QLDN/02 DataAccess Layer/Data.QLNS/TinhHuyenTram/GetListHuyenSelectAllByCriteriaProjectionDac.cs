...
3. Function     : QLDNMAIN/Huyen/Huyen
...
namespace SongAn.QLDN.Data.QLNS.Huyen
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListHuyenSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListHuyenSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_QuanHuyen_SelectAllByCriteriaProjection",
                    param: p,
