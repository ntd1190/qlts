...
3. Function     : QLDNMAIN/PhuongXa/PhuongXa
...
namespace SongAn.QLDN.Data.QLNS.PhuongXa
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListPhuongXaSelectAllByCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListPhuongXaSelectAllByCriteriaProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_PhuongXa_SelectAllByCriteriaProjection",
                    param: p,
