...
{
    public class GetListPopDuAnByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListPopDuAnByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_DuAn_GetListPopDuAnByCriteria",
                    param: p,
