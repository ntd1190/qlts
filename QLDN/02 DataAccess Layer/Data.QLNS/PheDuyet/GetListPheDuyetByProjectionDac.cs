...
{
    public class GetListPheDuyetByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListPheDuyetByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("SEARCH_LOAI", LoaiPhieu, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_PheDuyet_GetListPheDuyetByCriteria",
                    param: p,
