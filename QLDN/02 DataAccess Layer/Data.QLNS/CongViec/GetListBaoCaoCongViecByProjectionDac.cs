...
{
    public class GetListBaoCaoCongViecByProjectionDac : BaseRepositoryDataset
    {
        ...
        public GetListBaoCaoCongViecByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
