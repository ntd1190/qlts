...
namespace SongAn.QLDN.Data.QLNS.CongViec
{
    public class GetListCongViecByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListCongViecByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("SEARCH_DUANID", DuAnId, DbType.String);
                p.Add("SEARCH_CONGVIECID", CongViecId, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_CongViec_GetListCongViecByCriteria",
                    param: p,
