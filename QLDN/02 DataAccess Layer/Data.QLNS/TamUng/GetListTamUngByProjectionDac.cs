...
namespace SongAn.QLDN.Data.QLNS.TamUng
{
    public class GetListTamUngByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListTamUngByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("SEARCH_TAMUNGID", TamUngId, DbType.String);
                p.Add("SEARCH_TUNGAY", TuNgay, DbType.String);
                p.Add("SEARCH_DENNGAY", DenNgay, DbType.String);
                p.Add("SEARCH_TRANGTHAI", TheLoai, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_TamUng_GetListTamUngByCriteria",
                    param: p,
