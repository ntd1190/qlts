...
3. Function     : QLDNMAIN/BangLuongNhanVien/List
...
namespace SongAn.QLDN.Data.QLNS.BangLuongCaNhan
{
    ...
    /// </summary>
    public class GetListBangLuongNhanVienByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListBangLuongNhanVienByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_BangLuongNhanVien_GetListBangLuongNhanVienByCriteria",
                    param: this,
