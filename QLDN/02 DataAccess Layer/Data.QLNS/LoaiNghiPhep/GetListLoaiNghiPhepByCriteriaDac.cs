...
4. Description  : Goi sp de lay danh sach Loai Nghi Phep voi dieu kien
5. History      : 
*****************************************************************************/
using Dapper;
...
namespace SongAn.QLDN.Data.QLNS.LoaiNghiPhep
{
    /// <summary>
    /// DAC Lấy danh sách Nghỉ phép theo điều kiện
    /// </summary>
    public class GetListLoaiNghiPhepByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListLoaiNghiPhepByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_LoaiNghiPhep_GetListLoaiNghiPhepByCriteria",
                    param: this,
