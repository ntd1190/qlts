...
{
    public class GetListKhachHangByDiDongIssueDac : BaseRepositoryAsync
    {
        ...
        public GetListKhachHangByDiDongIssueDac(ContextDto context) : base(context.dbQLNSConnection)
        {
