...
4. Description  : THÔNG TIN CÔNG VIỆC TRƯỚC ĐÂY
...
namespace SongAn.QLDN.Data.QLNS.CongViecTruocDay
{
    ...
    /// </summary>
    public class GetListCongViecTruocDayByIdDac : BaseRepositoryAsync
    {
        ...
        public GetListCongViecTruocDayByIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_CongViecTruocDay_GetListCongViecTruocDayById",
                    param: p,
