...
namespace SongAn.QLDN.Data.QLNS.CongViecTruocDay
{
    ...
    /// </summary>
    public class GetListCongViecTruocDayByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListCongViecTruocDayByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_CongViecTruocDay_GetListCongViecTruocDayByCriteria",
                    param: p,
