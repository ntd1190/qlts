...
{
    public class GetListChamCongByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListChamCongByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ChamCong_GetListChamCongByCriteria",
                    param: p,
