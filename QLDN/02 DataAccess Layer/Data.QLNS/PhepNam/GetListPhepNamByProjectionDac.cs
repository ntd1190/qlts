...
namespace SongAn.QLDN.Data.QLNS.PhepNam
{
    public class GetListPhepNamByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListPhepNamByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("SEARCH_CHINHANH", ChiNhanh, DbType.String);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_PhepNam_GetListPhepnamByCriteria",
                    param: p,
