...
namespace SongAn.QLDN.Data.QLNS.ChiNhanh
{
    ...
    /// </summary>
    public class GetListChiNhanhPopupByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListChiNhanhPopupByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ChiNhanh_GetListChiNhanhPopupByCriteria",
                    param: p,
