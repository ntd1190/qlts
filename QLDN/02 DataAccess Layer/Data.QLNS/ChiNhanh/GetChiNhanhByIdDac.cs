...
4. Description  : THÔNG ITN CHI NHÁNH
...
namespace SongAn.QLDN.Data.QLNS.ChiNhanh
{
    ...
    /// </summary>
    public class GetChiNhanhByIdDac : BaseRepositoryAsync
    {
        #region public properties
        public string FIELD { get; set; }
        public int CHI_NHANH_ID { get; set; }
        ...
        public GetChiNhanhByIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ChiNhanh_GetChiNhanhById",
                    param: p,
