...
namespace SongAn.QLDN.Data.QLNS.ChiNhanh
{
    ...
    /// </summary>
    public class GetListChiNhanhByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListChiNhanhByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_ChiNhanh_GetListChiNhanhByCriteria",
                    param: p,
