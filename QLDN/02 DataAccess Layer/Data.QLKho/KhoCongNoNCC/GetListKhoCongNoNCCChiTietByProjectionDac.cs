...
{
    public class GetListKhoCongNoNCCChiTietByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoCongNoNCCChiTietByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoCongNoNCCChiTiet_GetListKhoCongNoNCCChiTietByCriteria",
                    param: p,
