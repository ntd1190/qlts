...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuXuat
{
    ...
    /// </summary>
    public class GetListKhoPhieuSeriesBySoPhieuDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoPhieuSeriesBySoPhieuDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuXuat_GetListSeriesBySoPhieu",
                    param: this,
