...
3. Function     : 
4. Description  : GỌI SP LẤY XÓA PHIẾU XUẤT
...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuXuat
{
    ...
    /// </summary>
    public class UpdateXoaListKhoPhieuXuatDac : BaseRepositoryAsync
    {
        ...
        public UpdateXoaListKhoPhieuXuatDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("@PHIEU_XUAT_ID", PHIEU_XUAT_ID);
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuXuat_UpdateXoaListKhoPhieuXuat",
                    param: p,
