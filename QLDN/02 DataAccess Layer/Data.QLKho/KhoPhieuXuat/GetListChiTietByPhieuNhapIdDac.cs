...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuXuat
{
    ...
    /// </summary>
    public class GetListChiTietByPhieuXuatIdDac : BaseRepositoryAsync
    {
        ...
        public GetListChiTietByPhieuXuatIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuXuat_GetListChiTietByPhieuXuatId",
                    param: this,
