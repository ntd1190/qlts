...
{
    public class GetListKhoKiemKeByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoKiemKeByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
