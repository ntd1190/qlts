...
{
    public class GetListKhoPhieuThuByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoPhieuThuByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
