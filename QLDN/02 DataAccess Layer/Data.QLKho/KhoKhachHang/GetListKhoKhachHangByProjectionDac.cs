...
namespace SongAn.QLDN.Data.QLNS.KhoKhachHang
{
    public class GetListKhoKhachHangByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoKhachHangByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        private void Init()
        {
            FieldsField = FieldsField.Equals("") ? nameof(Entity.MSSQL_QLDN_QLNS.Entity.KhoKhachHang.KhachHangId) : FieldsField;

            OrderClause = OrderClause.Equals("") ? nameof(Entity.MSSQL_QLDN_QLNS.Entity.KhoKhachHang.KhachHangId) : OrderClause;
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoKhachHang_GetListKhoKhachHangByCriteria",
                    param: p,
