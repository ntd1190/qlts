...
{
    public class GetListKhoHangHoaPopByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoHangHoaPopByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoHangHoa_GetListKhoHangHoaPopByCriteria",
                    param: p,
