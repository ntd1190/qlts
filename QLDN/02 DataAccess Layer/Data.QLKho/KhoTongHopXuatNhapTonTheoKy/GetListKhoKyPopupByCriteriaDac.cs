...
{
    public class GetListKhoKyPopupByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoKyPopupByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoKy_GetListKhoKyPopupByCriteria",
                    param: this,
