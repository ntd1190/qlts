...
namespace SongAn.QLDN.Data.QLNS.KhoLuocSu
{
    public class sp_KhoLuocSu_GetListKhoLuocSuByCriteriaDac : BaseRepositoryAsync
    {
        ...
        public sp_KhoLuocSu_GetListKhoLuocSuByCriteriaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                p.Add("DOITUONGID", DoiTuongId, DbType.String);
                p.Add("CHUCNANG", ChucNang, DbType.String);
                p.Add("ORDER_CLAUSE", OrderClause, DbType.String);
                p.Add("SKIP", Skip, DbType.Int16);
                p.Add("TAKE", Take, DbType.Int16);

                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoLuocSu_GetListKhoLuocSuByCriteria",
                    param: p,
