...
{
    public class GetListKhoCongNoKhachHangByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoCongNoKhachHangByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoCongNoKhachHang_GetListKhoCongNoKhachHangByCriteria",
                    param: p,
