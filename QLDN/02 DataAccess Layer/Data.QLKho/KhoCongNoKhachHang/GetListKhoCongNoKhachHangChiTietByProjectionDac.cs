...
namespace SongAn.QLDN.Data.QLKho.KhoCongNoKhachHang
{
    public class GetListKhoCongNoKhachHangChiTietByProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoCongNoKhachHangChiTietByProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoCongNoKhachHangChiTiet_GetListKhoCongNoKhachHangChiTietByCriteria",
                    param: p,
