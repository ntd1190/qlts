...
namespace SongAn.QLDN.Data.QLKho.KhoKhoHang
{
    ...
    /// </summary>
    public class GetKhoKhoHangByIdDac : BaseRepositoryAsync
    {
        ...
        public GetKhoKhoHangByIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoKhoHang_GetKhoKhoHangById",
                    param: this,
