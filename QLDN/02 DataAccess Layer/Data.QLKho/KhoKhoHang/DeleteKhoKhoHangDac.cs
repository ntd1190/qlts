...
namespace SongAn.QLDN.Data.QLKho.KhoKhoHang
{
    ...
    /// </summary>
    public class DeleteKhoKhoHangDac : BaseRepositoryAsync
    {
        ...
        public DeleteKhoKhoHangDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoKhoHang_DeleteKhoKhoHang",
                    param: this,
