...
namespace SongAn.QLDN.Data.QLKho.KhoKhoHang
{
    ...
    /// </summary>
    public class UpdateKhoKhoHangDac : BaseRepositoryAsync
    {
        #region public properties
        public int KHO_HANG_ID { get; set; }
        public string MA_KHO { get; set; }
        public string TEN_KHO { get; set; }
        public int CHI_NHANH { get; set; }
        ...
        public UpdateKhoKhoHangDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoKhoHang_UpdateKhoKhoHang",
                    param: this,
