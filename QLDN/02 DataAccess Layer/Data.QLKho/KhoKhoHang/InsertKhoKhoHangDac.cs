...
namespace SongAn.QLDN.Data.QLKho.KhoKhoHang
{
    ...
    /// </summary>
    public class InsertKhoKhoHangDac : BaseRepositoryAsync
    {
        ...
        public InsertKhoKhoHangDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoKhoHang_InsertKhoKhoHang",
                    param: this,
