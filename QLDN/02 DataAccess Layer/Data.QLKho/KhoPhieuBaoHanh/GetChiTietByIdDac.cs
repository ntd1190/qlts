...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </summary>
    public class GetChiTietByIdDac : BaseRepositoryAsync
    {
        #region public properties
        public int PHIEUBAOHANHCHITIET_ID { get; set; }
        ...
        public GetChiTietByIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuBaoHanh_GetChiTietById",
                    param: p,
