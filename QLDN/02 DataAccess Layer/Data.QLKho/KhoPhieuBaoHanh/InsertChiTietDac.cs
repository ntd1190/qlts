...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </summary>
    public class InsertChiTietDac : BaseRepositoryAsync
    {
        ...
        public InsertChiTietDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuBaoHanh_InsertChiTiet",
                    param: p,
