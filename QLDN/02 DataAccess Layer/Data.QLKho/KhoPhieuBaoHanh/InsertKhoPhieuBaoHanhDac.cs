...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </summary>
    public class InsertKhoPhieuBaoHanhDac : BaseRepositoryAsync
    {
        ...
        public InsertKhoPhieuBaoHanhDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuBaoHanh_InsertKhoPhieuBaoHanh",
                    param: p,
