...
3. Function     : 
4. Description  : CHI TIẾT PHIẾU BẢO HÀNH
...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </summary>
    public class GetListChiTietByPhieuBaoHanhIdDac : BaseRepositoryAsync
    {
        #region public properties
        public int PHIEUBAOHANH_ID { get; set; }
       ...
       public string MESSAGE { get; set; }
        ...
        public GetListChiTietByPhieuBaoHanhIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuBaoHanh_GetListChiTietByPhieuBaoHanhId",
                    param: p,
