...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuBaoHanh
{
    ...
    /// </summary>
    public class GetListKhoPhieuBaoHanhByIdDac : BaseRepositoryAsync
    {
        #region public properties
        public string @PHIEUBAOHANH_IDS { get; set; }
        ...
        public GetListKhoPhieuBaoHanhByIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuBaoHanh_GetListKhoPhieuBaoHanhById",
                    param: p,
