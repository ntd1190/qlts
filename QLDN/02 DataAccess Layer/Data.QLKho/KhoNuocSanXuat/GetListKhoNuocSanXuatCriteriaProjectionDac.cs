...
3. Function     : QLDNMAIN/KhoNuocSanXuat/KhoNuocSanXuat
...
namespace SongAn.QLDN.Data.QLKho.KhoNuocSanXuat
{
    /// <summary>
    /// DAC Lấy danh sách Phong ban theo điều kiện
    /// </summary>
    public class GetListKhoNuocSanXuatCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoNuocSanXuatCriteriaProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoNuocSanXuat_GetListKhoNuocSanXuatByCriteria",
                    param: p,
