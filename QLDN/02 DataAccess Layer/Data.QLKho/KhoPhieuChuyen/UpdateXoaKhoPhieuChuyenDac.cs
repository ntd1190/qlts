...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuChuyen
{
    ...
    /// </summary>
    public class UpdateXoaKhoPhieuChuyenDac : BaseRepositoryAsync
    {
        ...
        public UpdateXoaKhoPhieuChuyenDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuChuyen_UpdateXoaKhoPhieuChuyen",
                    param: p,
