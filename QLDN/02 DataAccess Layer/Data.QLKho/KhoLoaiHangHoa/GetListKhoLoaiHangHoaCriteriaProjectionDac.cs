...
namespace SongAn.QLDN.Data.QLKho.KhoLoaiHangHoa
{
    ...
    /// </summary>
    public class GetListKhoLoaiHangHoaCriteriaProjectionDac : BaseRepositoryAsync
    {
        ...
        public GetListKhoLoaiHangHoaCriteriaProjectionDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoLoaiHangHoa_GetListByCriteria",
                    param: this,
