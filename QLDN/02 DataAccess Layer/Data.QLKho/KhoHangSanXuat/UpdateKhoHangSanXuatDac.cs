...
namespace SongAn.QLDN.Data.QLKho.KhoHangSanXuat
{
    ...
    /// </summary>
    public class UpdateKhoHangSanXuatDac : BaseRepositoryAsync
    {
        ...
        public UpdateKhoHangSanXuatDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoHangSanXuat_UpdateKhoHangSanXuat",
                    param: this,
