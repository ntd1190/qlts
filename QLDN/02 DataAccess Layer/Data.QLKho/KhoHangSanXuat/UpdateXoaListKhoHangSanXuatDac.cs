...
namespace SongAn.QLDN.Data.QLKho.KhoHangSanXuat
{
    ...
    /// </summary>
    public class UpdateXoaListKhoHangSanXuatDac : BaseRepositoryAsync
    {
        #region public properties
        public string HANG_SAN_XUAT_IDS { get; set; }
        ...
        public UpdateXoaListKhoHangSanXuatDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoHangSanXuat_UpdateXoaListKhoHangSanXuat",
                    param: this,
