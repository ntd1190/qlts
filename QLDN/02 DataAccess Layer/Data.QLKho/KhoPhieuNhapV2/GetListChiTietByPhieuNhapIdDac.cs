...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuNhap
{
    ...
    /// </summary>
    public class GetListChiTietByPhieuNhapIdDac : BaseRepositoryAsync
    {
        ...
        public GetListChiTietByPhieuNhapIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuNhap_GetListChiTietByPhieuNhapId",
                    param: this,
