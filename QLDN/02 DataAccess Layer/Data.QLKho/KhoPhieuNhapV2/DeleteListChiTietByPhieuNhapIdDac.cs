...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuNhap
{
    ...
    /// </summary>
    public class DeleteListChiTietByPhieuNhapIdDac : BaseRepositoryAsync
    {
        ...
        public DeleteListChiTietByPhieuNhapIdDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuNhap_DeleteListChiTietByPhieuNhapId",
                    param: this,
