...
3. Function     : 
4. Description  : GỌI SP LƯU SỔ CÁI PHIẾU NHẬP
5. History      : 2017.06.19 (NGUYỄN THANH BÌNH) - Tao moi
                  2017.07.12 (NGUYỄN THANH BÌNH) - lưu sổ cái dùng sp, transaction
*****************************************************************************/
using Dapper;
...
namespace SongAn.QLDN.Data.QLKho.KhoPhieuNhap
{
    ...
    /// </summary>
    public class LuuSoCaiDac : BaseRepositoryAsync
    {
