...
3. Function     : 
4. Description  : INSERT PHIẾU NHẬP
5. History      : 2017.07.12 (NGUYỄN THANH BÌNH) - Tao moi
*****************************************************************************/
using Dapper;
...
{
    /// <summary>
    /// DAC thêm phiếu nhập và chi tiết
    /// </summary>
    public class InsertKhoPhieuNhapDac : BaseRepositoryAsync
    {
        ...
        public InsertKhoPhieuNhapDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoPhieuNhap_InsertKhoPhieuNhap",
                    param: p,
