...
{
    public class InsertTonDauHangHoaDac : BaseRepositoryAsync
    {
        ...
        public InsertTonDauHangHoaDac(ContextDto context) : base(context.dbQLNSConnection)
        {
        ...
        public virtual async Task<IEnumerable<dynamic>> Execute()
        {
            ...
            return await WithConnection(async c =>
            {
                ...
                var objResult = await c.QueryAsync<dynamic>(
                    sql: "sp_KhoTonKhoChiTiet_InsertTonDauHangHoa",
                    param: this,
