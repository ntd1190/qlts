(function () {
    ...
    angular
        .module('app')
        .controller('KhoPhieuThuFilterCtrl', KhoPhieuThuFilterCtrl)
    ...
    function KhoPhieuThuFilterCtrl($rootScope, $scope, utility) {
        /* jshint validthis:true */
        var controllerId = 'KhoPhieuThuFilterCtrl';
        ...
        //end HOT-KEY
        vm.title = 'KhoPhieuThuFilterCtrl';
        ...
        function search() {
            ...
            /////////
            var NguoiNopId = joinStr(vm.data.listNguoiNop, "NhanVienId");
            ...
            vm.data.searchString = $('#tungay').val() + '|' + $('#denngay').val() + '|' + KhachHangId + '|' + hinhthuc + '|' + NguoiNopId;
            /////////////
