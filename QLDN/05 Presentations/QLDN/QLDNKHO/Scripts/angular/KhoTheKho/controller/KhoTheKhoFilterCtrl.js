(function () {
    ...
    angular
        .module('app')
        .controller('KhoTheKhoFilterCtrl', KhoTheKhoFilterCtrl)
    ...
    function KhoTheKhoFilterCtrl($rootScope, $scope, utility) {
        /* jshint validthis:true */
        var controllerId = 'KhoTheKhoFilterCtrl';
