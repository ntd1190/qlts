(function () {
    ...
    angular
        .module('app')
        .controller('PhieuBaoHanhThongKeFilterCtrl', PhieuBaoHanhThongKeFilterCtrl)
    ...
    function PhieuBaoHanhThongKeFilterCtrl($rootScope, $scope, utility) {
        /* jshint validthis:true */
        var controllerId = 'PhieuBaoHanhThongKeFilterCtrl';
        ...
        //end HOT-KEY
        vm.title = 'PhieuBaoHanhThongKeFilterCtrl';
