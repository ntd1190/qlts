(function () {
    ...
    angular
        .module('app')
        .controller('KhoCongNoKhachHangFilterCtrl', KhoCongNoKhachHangFilterCtrl)
    ...
    function KhoCongNoKhachHangFilterCtrl($rootScope, $scope, utility) {
        /* jshint validthis:true */
        var controllerId = 'KhoCongNoKhachHangFilterCtrl';
        ...
        //end HOT-KEY
        vm.title = 'KhoCongNoKhachHangFilterCtrl';
