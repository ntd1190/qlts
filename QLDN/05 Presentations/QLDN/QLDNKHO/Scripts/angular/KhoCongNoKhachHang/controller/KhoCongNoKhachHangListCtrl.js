(function () {
    ...
    angular
        .module('app')
        .controller('KhoCongNoKhachHangListCtrl', KhoCongNoKhachHangListCtrl)
    ...
    //end HOT-KEY
    function KhoCongNoKhachHangListCtrl($rootScope, $scope, KhoCongNoKhachHangService, $timeout, ExcelExport) {
        /* =======================================
         * PRIVATE
         */
        var vm = this;
        ...
        var controllerId = 'KhoCongNoKhachHangListCtrl';
        var _tableState;
        ...
        function getPage(tableState) {
            ...
            vm.data.NgayKiemKho = vm.data.searchString.split('|')[0] + ' ~ ' + vm.data.searchString.split('|')[1];
            ...
            var fields = "";
            KhoCongNoKhachHangService.getPage(draw, start, number, searchString, sortName, sortDir, fields, vm.data.UserLoginId).then(function (success) {
