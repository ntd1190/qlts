(function () {
    ...
    angular
        .module('app')
        .controller('KhoSoDuTonKhoListCtrl', KhoSoDuTonKhoListCtrl)
    ...
    //end HOT-KEY
    function KhoSoDuTonKhoListCtrl($rootScope, $scope, KhoSoDuTonKhoService, $timeout, ExcelExport) {
        /* =======================================
         * PRIVATE
         */
        var vm = this;
        ...
        var controllerId = 'KhoSoDuTonKhoListCtrl';
        var _tableState;
         ...
         * FUNCTION
         */
        function activate() { vm.data.NgayKiemKho = moment().format('DD/MM/YYYY'); }
        ...
        function getPage(tableState) {
            ...
            var fields = "";
            KhoSoDuTonKhoService.getPage(draw, start, number, searchString, sortName, sortDir, fields,vm.data.UserLoginId).then(function (success) {
                if (success.data.data) {
                    vm.data.listKhoSoDuTonKho = success.data.data;
        ...
        function initEventListener() {
            ...
            $scope.$on(controllerId + '.action.getInfo', function (event, data) {
                var list = getKhoSoDuTonKhoInfo(data);
