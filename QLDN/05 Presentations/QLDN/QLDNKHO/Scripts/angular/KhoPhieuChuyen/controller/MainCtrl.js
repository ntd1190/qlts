...
(function () {
    ...
    function MainCtrl($scope, $rootScope, $http) {
        ...
        vm.controllerId = {
            ...
            KhoPhieuChuyenList: 'KhoPhieuChuyenList',
        ...
        vm.onInitView = function (config) {
            ...
            catchKhoPhieuChuyenFilterEvent();
        ...
        vm.keys = {
            ...
            F2: function (name, code) {
                console.log('F2');
                $scope.$broadcast(vm.controllerId.KhoPhieuChuyenList + '.action.F2');
            },
            ...
            F8: function (name, code) {
                //alert("F8");
                $scope.$broadcast(vm.controllerId.KhoPhieuChuyenFilter + '.action.F8'); 
        ...
        function catchTuyChonCotPopupEvent() {
            ...
            $scope.$on(vm.controllerId.TuyChonCotPopup + '.action.ap-dung', function (event, data) {
                ...
                $rootScope.$broadcast('KhoPhieuChuyenList.action.refresh');
            });
        ...
        function catchKhoPhieuChuyenFilterEvent() {
            $scope.$on(vm.controllerId.KhoPhieuChuyenFilter + '.data.filter', function (e, v) {
                console.log(v);
                $scope.$broadcast(vm.controllerId.KhoPhieuChuyenList + '.data.filter', v);
                $scope.$broadcast(vm.controllerId.KhoPhieuChuyenList + '.action.reload');
            });
        }
        ...
        function KhoKhoHangListPopupEvent() {
            $scope.$on(vm.controllerId.KhoKhoHangListPopup + '.action.ap-dung', function (e, v) {
                console.log(v);
                $scope.$broadcast(vm.controllerId.KhoPhieuChuyenFilter + '.data.listKhoHang', v);
