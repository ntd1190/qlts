(function () {
    'use strict';
    angular.module('app').controller('KhoPhieuXuatFilterCtrl', function ($scope, utility) {
        /* PRIVATE */
        ...
        vm.data.listTrangThai = [
            { MaTrangThai: 'KPX_KN', TrangThai: 'Kiểm nghiệm' },
            { MaTrangThai: 'KPX_LSC', TrangThai: 'Lưu sổ cái' },
        ];
