(function () {
    ...
    angular
        .module('app')
        .controller('KhoCongNoNCCListChiTietCtrl', KhoCongNoNCCListChiTietCtrl)
    ...
    //end HOT-KEY
    function KhoCongNoNCCListChiTietCtrl($rootScope, $scope, KhoCongNoNCCService, $timeout, ExcelExport) {
        /* =======================================
         * PRIVATE
         */
        var vm = this;
        ...
        var controllerId = 'KhoCongNoNCCListChiTietCtrl';
        var _tableState;
        ...
        function xemKhoPhieuChi(id) {
            $rootScope.$broadcast('KhoPhieuChiListCtrl.action.xemKhoPhieuChi', id);
        }
        ...
        function getPage(tableState) {
            ...
            var fields = "";
            KhoCongNoNCCService.getPageChiTiet(draw, start, number, searchString, sortName, sortDir, fields, vm.data.UserLoginId).then(function (success) {
                if (success.data.data) {
                    ...
                    for (var i = 0; i < vm.data.listKhoCongNoNCC.length; i++) {
                        var kho = vm.data.listKhoCongNoNCC[i];
                        vm.data.NhaCungCap = kho.Ten;
                    ...
                    vm.data.DuCuoi = vm.data.listKhoCongNoNCC[0].TienNhap + vm.data.TongNhap - vm.data.TongChi;
                }
