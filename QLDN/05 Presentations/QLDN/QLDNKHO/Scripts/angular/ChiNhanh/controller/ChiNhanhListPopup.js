(function () {
    ...
    angular.module("app")
        .service('ChiNhanhListPopupService', service)
        .controller("ChiNhanhListPopupCtrl", controller);

    function controller($scope, ChiNhanhListPopupService, utility) {
        ...
        vm.controllerId = 'ChiNhanhListPopupCtrl';
        vm.title = 'Danh sách chi nhánh';
        ...
        vm.data.listCot = [
            { MaCot: 'MaChiNhanh', TenCot: 'Mã', HienThiYN: true, DoRong: 100 },
            { MaCot: 'TenChiNhanh', TenCot: 'Tên', HienThiYN: true, DoRong: 0 },
        ];
        ...
        vm.action.apDung = function () {
            var data = {};
            data.listChiNhanh = getSelectedList(vm.data.listChiNhanh);
            emitApDung(data);
        };
        ...
        function getPage(tableState) {
            ...
            ChiNhanhListPopupService.getPage(data).then(function (result) {
                console.log(result);
    ...
    function service($http, API_BASE) {
        ...
        api.GetPage = 'GetListChiNhanhPopupByCriteria';
