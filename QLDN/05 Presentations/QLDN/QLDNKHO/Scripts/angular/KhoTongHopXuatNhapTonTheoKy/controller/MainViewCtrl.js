(function () {
    ...
    module.controller('MainViewCtrl', function ($scope) {
        /*** PRIVATE ***/
        ...
        vm.controllerId = {
            TongHopXuatNhapTonTheoKyViewList: 'TongHopXuatNhapTonTheoKyViewListCtrl'
        };
        ...
        (function activate() {
            TongHopXuatNhapTonTheoKyViewListEvent();
        })();
        ...
        function TongHopXuatNhapTonTheoKyViewListEvent() {
        }
    });
})();
