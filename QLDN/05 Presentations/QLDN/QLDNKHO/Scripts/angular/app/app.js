        ...
        jQuery(".datetimepicker").each(function () {
            if (jQuery(this).hasClass('date')) {
                jQuery(this).datetimepicker({
                    mask: '39/19/9999', format: 'd/m/Y', timepicker: false,  scrollInput: false,
                })
            }
                ...
                jQuery(this).datetimepicker({
                    mask: '39/19/9999 29:59', format: 'd/m/Y H:i', scrollInput: false
                })
            }
                ...
                jQuery(this).datetimepicker({
                    mask: '39/19/9999 29:59', format: 'd/m/Y H:i', maxDate: 'now', scrollInput: false
                })
            }
        });
    }
