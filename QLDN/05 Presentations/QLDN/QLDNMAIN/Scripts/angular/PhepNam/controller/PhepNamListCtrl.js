(function () {
    ...
    angular
        .module('app')
        .controller('PhepNamListCtrl', PhepNamListCtrl)
    ...
    //end HOT-KEY
    function PhepNamListCtrl($rootScope, $scope, PhepNamService, TuyChonCotService, utility) {
        /* =======================================
         * PRIVATE
         */
        var vm = this;
        ...
        //end HOT-KEY
        var controllerId = 'PhepNamListCtrl';
        var _tableState;
...
Phép năm còn lại
        */
        ...
        function getPage(tableState) {
            ...
            PhepNamService.getPage(draw, start, number, searchString, sortName, sortDir, fields, vm.data.UserLoginId).then(function (success) {
                if (success.data.data) {
                    if (success.data.data.length > 0) {
                        vm.data.listPhepNam = success.data.data;
        ...
        function apDung() {
            ...
            for (var i = 0; i < vm.data.listPhepNam.length; i++) {
                if (vm.data.listPhepNam[i].isSelected) {
                    selectedlistPhepNam.push(vm.data.listPhepNam[i]);
                }
            }
