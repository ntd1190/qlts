(function () {
    ...
    angular
        .module('app')
        .factory('TamUngService', TamUngService);

    function TamUngService($http, API_BASE) {
        var api = {
            url: API_BASE + 'api.QLNS/TamUng/',
            insert: 'InsertTamUng',
            update: 'UpdateTamUng',
            GetList: 'GetListTamUng',
            GetPage: 'GetListTamUngByProjection',
            GetById: 'GetTamUngById',
            GetListBySearchString: 'GetListTamUngBySearchString',
            getList: 'getList',
            getListCount: 'getListCount',
            getListProjection: 'getListProjection',
            remove: 'DeleteTamUng',
            removeList: 'UpdateXoaListTamUng',
        }
        ...
        function removeList(data) {
            ...
            var req = {
                ...
                data: { tamUng: angular.toJson(data) }
            }
