(function () {
    ...
    angular
        .module('app')
        .factory('KyLuatService', KyLuatService);

    function KyLuatService($http, API_BASE) {
        var api = {
            url: API_BASE + 'api.QLNS/KyLuat/',
            insert: 'InsertKyLuat',
            update: 'UpdateKyLuat',
            GetList: 'GetListKyLuat',
            GetPage: 'GetListKyLuatByProjection',
            GetById: 'GetKyLuatById',
            GetListBySearchString: 'GetListKyLuatBySearchString',
            getList: 'getList',
            getListCount: 'getListCount',
            getListProjection: 'getListProjection',
            remove: 'DeleteKyLuat',
            removeList: 'DeleteListKyLuat',
        }
