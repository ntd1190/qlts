(function () {
    ...
    function MainCtrl($scope, $rootScope, $http) {
        ...
        vm.controllerId = {
            ...
            BangLuongNhanVienFilterCtrl: 'BangLuongNhanVienFilterCtrl',
            BangLuongNhanVienListCtrl: 'BangLuongNhanVienListCtrl',
        ...
        function catchNhanVienListPopupEvent() {
            $scope.$on(vm.controllerId.NhanVienListPopup + '.action.ap-dung', function (event, data) {
                $rootScope.$broadcast(vm.controllerId.BangLuongNhanVienFilterCtrl + '.data.listBangLuongNhanVien', data);
        ...
        function catchPhongBanListPopupEvent() {
            $scope.$on(vm.controllerId.PhongBanListPopup + '.action.ap-dung', function (event, data) {
                $rootScope.$broadcast(vm.controllerId.BangLuongNhanVienFilterCtrl + '.data.listPhongBan', data);
                $('#PhongBanListPopup').collapse('hide');
            });
        }

        function catchNhanVienFilterEvent() {
            $scope.$on(vm.controllerId.BangLuongNhanVienFilterCtrl + '.action.filters', function (event, data) {
                $scope.$broadcast(vm.controllerId.BangLuongNhanVienListCtrl + '.action.get-filters', data);
            });
