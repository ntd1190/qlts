...
namespace Nop.Admin.Controllers
{
    public partial class NewsController : BaseAdminController
	{
        ...
        public virtual ActionResult Create(NewsItemModel model, bool continueEditing)
        {
            ...
            {
                int prevPictureId = model.PictureId;
        ...
        [NonAction]
        protected virtual void UpdatePictureSeoNames(NewsItem category)
        {
            var picture = _pictureService.GetPictureById(category.PictureId);
            if (picture != null)
                _pictureService.SetSeoFilename(picture.Id, _pictureService.GetPictureSeName(category.Title));
        }
