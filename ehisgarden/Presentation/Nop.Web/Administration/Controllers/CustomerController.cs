...
namespace Nop.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
            ...
            [ModelBinder(typeof(CommaSeparatedModelBinder))] int[] searchCustomerRoleIds)
        {
            ...
            if (_workContext.CurrentCustomer.IsVendor() == true)
            {
                var gridModel = new DataSourceResult
                {
                    Data = customers.Where(t=> t.CreateById == _workContext.CurrentCustomer.Id).Select(PrepareCustomerModelForList),
        ...
        public virtual ActionResult Create(CustomerModel model, bool continueEditing, FormCollection form)
        {
            ...
            {
                model.Email = "ehisgarden@gmail.com";
                model.SelectedCustomerRoleIds.Clear();
                model.SelectedCustomerRoleIds.Add(3);
            }
            ...
            if (ModelState.IsValid)
            {
                var customer = new Customer
                {
                    ...
                    CreateById = _workContext.CurrentCustomer.Id,
