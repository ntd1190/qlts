    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("Register",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //guarantee
            routes.MapLocalizedRoute("Orderfirstcheck",
                            "guarantee/",
                            new { controller = "Order", action = "Guarantee" },
                            new[] { "Nop.Web.Controllers" });
            //resultcheck
            routes.MapLocalizedRoute("Orderresult",
                            "resultcheck/",
                            new { controller = "Order", action = "CustomerList" },
                            new[] { "Nop.Web.Controllers" });
            //logout
            ...
            routes.MapLocalizedRoute("OrderDetails",
                            ...
                            new { orderId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("OrderDetails1",
                         "orderdetails1/{orderId}",
                         new { controller = "Order", action = "Details1" },
                         new { orderId = @"\d+" },
                         new[] { "Nop.Web.Controllers" });
