    ...
    public partial class NewsModelFactory : INewsModelFactory
    {
        ...
        public virtual HomePageNewsItemsModel PrepareHomePageNewsItemsModel()
        {
            ...
            foreach (var newsItemModel in model.NewsItems)
            {
                ...
                newsItemModel.DefaultPictureModel = PrepareNewsOverviewPictureModel(newsItemModel);
            }
               
            return model;
        }
        protected virtual PictureModel PrepareNewsOverviewPictureModel(NewsItemModel product, int? productThumbPictureSize = null)
        {
            if (product == null)
            ...
            {
                var picture = _pictureService.GetPicturesByNewsId(product.Id, 1).FirstOrDefault();
                ...
                pictureModel.Title = (picture != null && !string.IsNullOrEmpty(picture.TitleAttribute))
                    ...
                    : string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat"), product.Title);
                //"alt" attribute
