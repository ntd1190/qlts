...
namespace TinyFileManager.NET
{
    ...
    public partial class dialog : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.User.Identity.Name == "hongquan@ehisgarden.vn")
            {
                ...
                switch (strCmd)
                {
                    ...
                    case "createfolder":
                        try
                        {
                            ...
                            //catch will save us
                            Directory.CreateDirectory(this.objConfig.strUploadPath + "\\" + strFolder.Replace(" ", ""));
                            Directory.CreateDirectory(this.objConfig.strThumbPath + "\\" + strFolder.Replace(" ", ""));
                    ...
                    case "upload":
                        ...
                        {
                            strTargetFile = this.objConfig.strUploadPath + this.strFolder + filUpload.FileName.ToLower().Replace(" ", "-");
                            strThumbFile = this.objConfig.strThumbPath + this.strFolder + filUpload.FileName.ToLower().Replace(" ", "-");
                    ...
                    default:    //just a regular page load
                        ...
                        foreach (string strF in arrFiles)
                        {
                            ...
                            if ((this.boolOnlyImage && this.objFItem.boolIsImage) || (this.boolOnlyVideo && this.objFItem.boolIsVideo) || (!this.boolOnlyImage && !this.boolOnlyVideo))
                            {
                                ...
                                this.objFItem.strLink = "<a href=\"#\" title=\"Select\" onclick=\"" + this.strApply + "('" + this.objConfig.strUploadURL + "/" + this.objFItem.strPath.Replace('\\', '/') + "'," + this.strType + ")\";\"><img data-src=\"holder.js/140x100\" alt=\"140x100\" src=\"" + this.objFItem.strThumbImage.Replace(":8282", "") + "\" height=\"100\"><h4>" + this.objFItem.strName + "</h4></a>";
            ...
            {
                Response.Redirect("https://www.google.com.vn/#q=thang+ngu");
            }
        }
