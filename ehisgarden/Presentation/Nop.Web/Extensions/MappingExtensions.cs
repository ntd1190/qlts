...
namespace Nop.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        //public static BannerPostModel ToModel(this BannerPost entity)
        //{
        //    return entity.MapTo<BannerPost, BannerPostModel>();
        //}

        //public static BannerPost ToEntity(this BannerPostModel model)
        //{
        //    return model.MapTo<BannerPostModel, BannerPost>();
        //}

        //public static BannerPost ToEntity(this BannerPostModel model, BannerPost destination)
        //{
