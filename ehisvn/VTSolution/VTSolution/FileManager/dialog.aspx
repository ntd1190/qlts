<%@ Page Title="Tiny File Manager" Language="C#" AutoEventWireup="true" CodeBehind="~/TinyFileManager.NET/dialog.aspx.cs" Inherits="ProjectWeb.TinyFileManager.NET.dialog" %>
<%@ Import Namespace="ProjectWeb.TinyFileManager.NET.classes" %>
            ...
            <div class="row-fluid ff-container">
                <div class="span12 pull-right">
                    ...
                    <%  
                        ...
                        foreach (clsFileItem objF in this.arrLinks)
                        {
