...
;(function($){
    $.fn.responsiveGallery = function(option){
		...
		function getTransform9CSS() {
		  var cssArray;

		  if (support3d) {
		    cssArray = [
					getTransform3dCSS('-50%', -10, 0, -2, 0, 'hidden'),
					getTransform3dCSS('0', -8, 0, -1, 1, 'visible'),
					getTransform3dCSS('50%', -6, 0, 0, 1, 'visible'),
					getTransform3dCSS('100%', -4, 0, 1, 1, 'visible'),
					getTransform3dCSS('150%', -2, 0, 2, 1, 'visible'),
					getTransform3dCSS('200%', 0, 0, 3, 1, 'visible'),
					getTransform3dCSS('250%', -2, -0, 2, 1, 'visible'),
         	getTransform3dCSS('300%', -4, -0, 1, 1, 'visible'),
          getTransform3dCSS('350%', -6, -0, 0, 1, 'visible'),
					getTransform3dCSS('400%', -8, -0, -1, 1, 'visible'),
					getTransform3dCSS('450%', -10, 0, -2, 0, 'hidden')
		    ];
		  } else if (support2d) {
		    cssArray = [
					getTransform2dCSS('-50%', 1, '100%', '50%', 0, 'hidden'),
					getTransform2dCSS('0', 1, '100%', '50%', 1, 'visible'),
          getTransform2dCSS('50%', 1, '100%', '50%', 1, 'visible'),
					getTransform2dCSS('100%', 1, '100%', '50%', 1, 'visible'),
					getTransform2dCSS('150%', 1, '50%', '50%', 1, 'visible'),
					getTransform2dCSS('200%', 1, '50%', '50%', 1, 'visible'),
					getTransform2dCSS('250%', 1, '50%', '50%', 1, 'visible'),
					getTransform2dCSS('300%', 1, '0%', '50%', 1, 'visible'),
          getTransform2dCSS('350%', 1, '0%', '50%', 1, 'visible'),
					getTransform2dCSS('400%', 1, '0%', '50%', 1, 'visible'),
					getTransform2dCSS('450%', 1, '0%', '50%', 0, 'hidden')
		    ];
		  }
		...
		function getTransform7CSS(){
			...
			if(support3d){
				cssArray = [
					getTransform3dCSS('-60%',	-8,	0,		-1,	0,	'hidden'),
					getTransform3dCSS('0',		-6,	0,		-1,	1,	'visible'),

					getTransform3dCSS('60%', 	-4, 	0,		0,	1,	'visible'),
					getTransform3dCSS('120%', 	-2, 0,		1,	1,	'visible'),
					getTransform3dCSS('180%', 	0, 		0,		2,	1,	'visible'),
					getTransform3dCSS('240%', 	-2, 	0,	1,	1,	'visible'),
					getTransform3dCSS('300%', 	-4, 	-0,	0,	1,	'visible'),

					getTransform3dCSS('360%', 	-6, 	-0,	-1,	1,	'visible'),
					getTransform3dCSS('420%', 	-8, 	0,	-1,	0,	'hidden')
				];
			} else if(support2d){
				cssArray = [
					getTransform2dCSS('-60%',	1,	'100%',		'50%',	0,	'hidden'),
					getTransform2dCSS('0',		1,	'100%',		'50%',	1,	'visible'),

					getTransform2dCSS('60%', 	1,	'100%',		'50%',	1,	'visible'),
					getTransform2dCSS('120%', 	1,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('180%', 	1,		'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('240%', 	1,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('300%', 	1,	'0%',		'50%',	1,	'visible'),

					getTransform2dCSS('360%', 	1,	'0%',		'50%',	1,	'visible'),
					getTransform2dCSS('420%', 	1,	'0%',		'50%',	0,	'hidden')
				];
			}
		...
		function getTransform5CSS(){
			...
			if(support3d){
				cssArray = [
					getTransform3dCSS('-50%',	-6, 	0,		-1,	0,	'hidden'),

					getTransform3dCSS('0', 		-4, 	0,		0,	1,	'visible'),
					getTransform3dCSS('50%', 	-2, 	0,		1,	1,	'visible'),
					getTransform3dCSS('100%', 	0, 		0,		2,	1,	'visible'),
					getTransform3dCSS('150%', 	-2, 	-0,	1,	1,	'visible'),
					getTransform3dCSS('200%', 	-4, 	-0,	0,	1,	'visible'),

					getTransform3dCSS('250%', 	-6, 	-0,	-1,	0,	'hidden')
				];
			} else if(support2d){
				cssArray = [
					getTransform2dCSS('-50%',	1,	'100%',		'50%',	0,	'hidden'),
					...
					getTransform2dCSS('0', 		1,	'100%',		'50%',	1,	'visible'),
					getTransform2dCSS('50%', 	1,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('100%', 	1,		'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('150%', 	1,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('200%', 	1,	'0%',		'50%',	1,	'visible'),

					getTransform2dCSS('250%', 	1,	'0%',		'50%',	0,	'hidden')
				];
			}
		...
		function getTransform3CSS(){
			...
			if(support3d){
				cssArray = [
					getTransform3dCSS('-50%',	-4, 	0,		0,	0,	'hidden'),

					getTransform3dCSS('0', 		-2, 	0,		1,	1,	'visible'),
					getTransform3dCSS('50%', 	0, 		0,		2,	1,	'visible'),
					getTransform3dCSS('100%', 	-2, 	-0,	1,	1,	'visible'),

					getTransform3dCSS('150%', 	-4, 	-0,	0,	0,	'hidden')
				];
			} else if(support2d){
				cssArray = [
					getTransform2dCSS('-50%',	1,	'100%',		'50%',	0,	'hidden'),
					...
					getTransform2dCSS('150%', 	1,	'0%',		'50%',	0,	'hidden')
				];
			}
		...
		function getTransform1CSS(){
			...
			if(support3d){
				cssArray = [
					getTransform3dCSS('-100%',	-2, 	0,		0,	0,	'hidden'),
				...
				cssArray = [
					getTransform2dCSS('-100%',	1,	'100%',		'50%',	0,	'hidden'),

					getTransform2dCSS('0', 	1,		'50%',		'50%',	1,	'visible'),

					getTransform2dCSS('100%', 	1,	'0%',		'50%',	0,	'hidden')
				];
			}
		...
		$(window).on('resize', function(e){
			...
			rgShowCount =Math.round(wrapperWidth/itemWidth*2-0.7);
			...
			}  else if(rgShowCount === 9){
				rgTansCSS = getTransform9CSS();
			}
